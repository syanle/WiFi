.class public Lim/yixin/sdk/util/SDKHttpUtils;
.super Ljava/lang/Object;


# static fields
.field private static final DEFAULT_AGENT:Ljava/lang/String; = "yixin_sdk_httputils/0.00"
...
.method private getEntity(Ljava/lang/String;Ljava/util/Map;)Lorg/apache/http/HttpEntity;
    ...
    const-string v1, "yixin_sdk_httputils/0.00"
    ...
    const-string v1, "SDKHttpUtils"

    const-string v2, "SDKHttpUtils getEntity data error"
...
.method public static declared-synchronized getInstance()Lim/yixin/sdk/util/SDKHttpUtils;
    .locals 2
...
.method public get4ErrorLog(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Lim/yixin/sdk/util/SDKLogger;->e(Ljava/lang/Class;Ljava/lang/String;)V
    ...
    invoke-interface {v3}, Lim/yixin/sdk/api/IYXAPI;->getAppId()Ljava/lang/String;
    ...
    const-string v3, "http://open.yixin.im/sdk/log?log="
    ...
    invoke-virtual {p0, v1, v3}, Lim/yixin/sdk/util/SDKHttpUtils;->get(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_2
    const-class v3, Lim/yixin/sdk/api/YXTextMessageData;
    ...
    :cond_4
    const-class v3, Lim/yixin/sdk/api/YXMusicMessageData;
    ...
    :cond_5
    const-class v3, Lim/yixin/sdk/api/YXVideoMessageData;
    ...
    :cond_6
    const-class v3, Lim/yixin/sdk/api/YXWebPageMessageData;
    ...
    const-string v3, "SDKHttpUtils"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "SDKHttpUtils getStream error: "
