...
.method public addRule(Lorg/dom4j/rule/Rule;)V
    ...
    .prologue
    .line 63
    iget v4, p0, Lorg/dom4j/rule/RuleManager;->appearenceCount:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, Lorg/dom4j/rule/RuleManager;->appearenceCount:I

    invoke-virtual {p1, v4}, Lorg/dom4j/rule/Rule;->setAppearenceCount(I)V
    ...
    invoke-virtual {p0, v4}, Lorg/dom4j/rule/RuleManager;->getMode(Ljava/lang/String;)Lorg/dom4j/rule/Mode;

    move-result-object v2

    .line 66
    .local v2, "mode":Lorg/dom4j/rule/Mode;
    invoke-virtual {p1}, Lorg/dom4j/rule/Rule;->getUnionRules()[Lorg/dom4j/rule/Rule;

    move-result-object v0

    .line 68
    .local v0, "childRules":[Lorg/dom4j/rule/Rule;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {v2, v4}, Lorg/dom4j/rule/Mode;->addRule(Lorg/dom4j/rule/Rule;)V
    ...
    .end local v3    # "size":I
    :cond_0
    invoke-virtual {v2, p1}, Lorg/dom4j/rule/Mode;->addRule(Lorg/dom4j/rule/Rule;)V
...
.method public removeRule(Lorg/dom4j/rule/Rule;)V
    ...
    invoke-virtual {v2, v4}, Lorg/dom4j/rule/Mode;->removeRule(Lorg/dom4j/rule/Rule;)V
    ...
    .end local v3    # "size":I
    :cond_0
    invoke-virtual {v2, p1}, Lorg/dom4j/rule/Mode;->removeRule(Lorg/dom4j/rule/Rule;)V
