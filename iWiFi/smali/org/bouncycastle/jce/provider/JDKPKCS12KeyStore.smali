...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$1;,
...
.method private static calculatePbeMac(Lorg/bouncycastle/asn1/DERObjectIdentifier;[BI[CZ[B)[B
    ...
    invoke-virtual {v0, p4}, Lorg/bouncycastle/jce/provider/JCEPBEKey;->setTryWrongPKCS12Zero(Z)V

    invoke-virtual {p0}, Lorg/bouncycastle/asn1/DERObjectIdentifier;->getId()Ljava/lang/String;

    move-result-object v2

    sget-object v3, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->bcProvider:Ljava/security/Provider;
...
.method private doStore(Ljava/io/OutputStream;[CZ)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->random:Ljava/security/SecureRandom;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    invoke-virtual {v2, v1}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keyAlgorithm:Lorg/bouncycastle/asn1/DERObjectIdentifier;
    ...
    invoke-virtual {p0, v3, v2, v4, v0}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->wrapKey(Ljava/lang/String;Ljava/security/Key;Lorg/bouncycastle/asn1/pkcs/PKCS12PBEParams;[C)[B

    move-result-object v3

    new-instance v7, Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;

    iget-object v8, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keyAlgorithm:Lorg/bouncycastle/asn1/DERObjectIdentifier;

    invoke-virtual {v4}, Lorg/bouncycastle/asn1/pkcs/PKCS12PBEParams;->getDERObject()Lorg/bouncycastle/asn1/DERObject;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_friendlyName:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-interface {v2, v3, v9}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->setBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V

    :cond_2
    sget-object v3, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_localKeyId:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    sget-object v9, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_localKeyId:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v3}, Ljava/security/cert/Certificate;->getPublicKey()Ljava/security/PublicKey;

    move-result-object v3

    invoke-direct {p0, v3}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->createSubjectKeyId(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/SubjectKeyIdentifier;

    move-result-object v3

    invoke-interface {v2, v9, v3}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->setBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-virtual {v4, v10}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-virtual {v7, v10}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_localKeyId:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    sget-object v2, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs8ShroudedKeyBag:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v8}, Lorg/bouncycastle/asn1/pkcs/EncryptedPrivateKeyInfo;->getDERObject()Lorg/bouncycastle/asn1/DERObject;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/DERSequence;->getDEREncoded()[B

    move-result-object v1

    new-instance v7, Lorg/bouncycastle/asn1/BERConstructedOctetString;

    invoke-direct {v7, v1}, Lorg/bouncycastle/asn1/BERConstructedOctetString;-><init>([B)V

    const/16 v1, 0x14

    new-array v1, v1, [B

    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->random:Ljava/security/SecureRandom;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certAlgorithm:Lorg/bouncycastle/asn1/DERObjectIdentifier;

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/pkcs/PKCS12PBEParams;->getDERObject()Lorg/bouncycastle/asn1/DERObject;

    move-result-object v2

    invoke-direct {v3, v1, v2}, Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    sget-object v2, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->x509Certificate:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {v11, v2, v5}, Lorg/bouncycastle/asn1/pkcs/CertBag;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DERObject;)V
    ...
    sget-object v5, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_friendlyName:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-interface {v2, v5}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->getBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;)Lorg/bouncycastle/asn1/DEREncodable;
    ...
    invoke-interface {v2, v5, v13}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->setBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V

    :cond_9
    sget-object v5, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_localKeyId:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {p0, v13}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->createSubjectKeyId(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/SubjectKeyIdentifier;
    ...
    invoke-direct {v14, v5}, Lorg/bouncycastle/asn1/DERSet;-><init>(Lorg/bouncycastle/asn1/DEREncodable;)V

    invoke-virtual {v6, v14}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V

    new-instance v5, Lorg/bouncycastle/asn1/DERSequence;

    invoke-direct {v5, v6}, Lorg/bouncycastle/asn1/DERSequence;-><init>(Lorg/bouncycastle/asn1/ASN1EncodableVector;)V

    invoke-virtual {v12, v5}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-virtual {v2, v5}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-direct {p0, v6}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->createSubjectKeyId(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/SubjectKeyIdentifier;
    ...
    invoke-virtual {v12, v1}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V

    :cond_c
    new-instance v1, Lorg/bouncycastle/asn1/pkcs/SafeBag;

    sget-object v2, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certBag:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v11}, Lorg/bouncycastle/asn1/pkcs/CertBag;->getDERObject()Lorg/bouncycastle/asn1/DERObject;
    ...
    invoke-direct {v1, v2, v5, v6}, Lorg/bouncycastle/asn1/pkcs/SafeBag;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DERObject;Lorg/bouncycastle/asn1/ASN1Set;)V

    invoke-virtual {v8, v1}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certs:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    invoke-virtual {v4, v1}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->x509Certificate:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {v11, v4, v5}, Lorg/bouncycastle/asn1/pkcs/CertBag;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DERObject;)V
    ...
    invoke-interface {v4, v5, v13}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->setBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-virtual {v5, v14}, Lorg/bouncycastle/asn1/DERObjectIdentifier;->equals(Ljava/lang/Object;)Z
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certBag:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {v1, v4, v5, v6}, Lorg/bouncycastle/asn1/pkcs/SafeBag;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DERObject;Lorg/bouncycastle/asn1/ASN1Set;)V
    ...
    check-cast v1, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$CertId;
    ...
    invoke-direct {v5, v2, v6}, Lorg/bouncycastle/asn1/pkcs/CertBag;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DERObject;)V
    ...
    invoke-virtual {v2, v11}, Lorg/bouncycastle/asn1/DERObjectIdentifier;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v1, v2}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->getBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;)Lorg/bouncycastle/asn1/DEREncodable;

    move-result-object v2

    invoke-direct {v12, v2}, Lorg/bouncycastle/asn1/DERSet;-><init>(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-direct {v1, v2, v5, v10}, Lorg/bouncycastle/asn1/pkcs/SafeBag;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DERObject;Lorg/bouncycastle/asn1/ASN1Set;)V
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->data:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    new-instance v5, Lorg/bouncycastle/asn1/BERConstructedOctetString;

    invoke-direct {v5, v1}, Lorg/bouncycastle/asn1/BERConstructedOctetString;-><init>([B)V

    invoke-direct {v2, v4, v3, v5}, Lorg/bouncycastle/asn1/pkcs/EncryptedData;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    sget-object v5, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->data:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-direct {v4, v5, v7}, Lorg/bouncycastle/asn1/pkcs/ContentInfo;-><init>(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    sget-object v5, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->encryptedData:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/pkcs/EncryptedData;->getDERObject()Lorg/bouncycastle/asn1/DERObject;
    ...
    sget-object v2, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->data:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v7}, Lorg/bouncycastle/asn1/pkcs/ContentInfo;->getContent()Lorg/bouncycastle/asn1/DEREncodable;
    ...
    :try_start_4
    sget-object v1, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->id_SHA1:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    sget-object v5, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->id_SHA1:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {v5, v4, v1}, Lorg/bouncycastle/asn1/x509/DigestInfo;-><init>(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[B)V

    new-instance v1, Lorg/bouncycastle/asn1/pkcs/MacData;

    invoke-direct {v1, v5, v2, v3}, Lorg/bouncycastle/asn1/pkcs/MacData;-><init>(Lorg/bouncycastle/asn1/x509/DigestInfo;[BI)V
    :try_end_4
...
.method protected cryptData(ZLorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[CZ[B)[B
    ...
    sget-object v2, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->bcProvider:Ljava/security/Provider;
...
.method public engineGetCertificateChain(Ljava/lang/String;)[Ljava/security/cert/Certificate;
    ...
    invoke-direct {v4, p0, v6}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$CertId;-><init>(Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;[B)V
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {v10}, Lorg/bouncycastle/asn1/pkcs/ContentInfo;->getContent()Lorg/bouncycastle/asn1/DEREncodable;
    ...
    invoke-static/range {v2 .. v7}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->calculatePbeMac(Lorg/bouncycastle/asn1/DERObjectIdentifier;[BI[CZ[B)[B
    ...
    invoke-static {v2, v11}, Lorg/bouncycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
    ...
    :goto_1
    new-instance v2, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;-><init>(Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$1;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;
    ...
    invoke-virtual {v10}, Lorg/bouncycastle/asn1/pkcs/ContentInfo;->getContentType()Lorg/bouncycastle/asn1/DERObjectIdentifier;

    move-result-object v2

    sget-object v3, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->data:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    new-instance v4, Lorg/bouncycastle/asn1/pkcs/AuthenticatedSafe;
    ...
    invoke-direct {v4, v2}, Lorg/bouncycastle/asn1/pkcs/AuthenticatedSafe;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V

    invoke-virtual {v4}, Lorg/bouncycastle/asn1/pkcs/AuthenticatedSafe;->getContentInfo()[Lorg/bouncycastle/asn1/pkcs/ContentInfo;
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs8ShroudedKeyBag:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v0, v3, v4, v1, v6}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->unwrapKey(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[B[CZ)Ljava/security/PrivateKey;
    ...
    invoke-interface {v3, v7}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->getBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;)Lorg/bouncycastle/asn1/DEREncodable;

    move-result-object v13

    if-eqz v13, :cond_6

    invoke-interface {v13}, Lorg/bouncycastle/asn1/DEREncodable;->getDERObject()Lorg/bouncycastle/asn1/DERObject;

    move-result-object v13

    invoke-virtual {v13, v5}, Lorg/bouncycastle/asn1/DERObject;->equals(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-interface {v3, v7, v5}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->setBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;Lorg/bouncycastle/asn1/DEREncodable;)V

    :cond_7
    :goto_5
    sget-object v13, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_friendlyName:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v7, v13}, Lorg/bouncycastle/asn1/DERObjectIdentifier;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v7, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    invoke-virtual {v7, v5, v4}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->put(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_8
    sget-object v13, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_localKeyId:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    iget-object v5, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;
    ...
    iget-object v3, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->encryptedData:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    new-instance v5, Lorg/bouncycastle/asn1/pkcs/EncryptedData;
    ...
    invoke-direct {v5, v2}, Lorg/bouncycastle/asn1/pkcs/EncryptedData;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V

    const/4 v3, 0x0

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/pkcs/EncryptedData;->getEncryptionAlgorithm()Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;

    move-result-object v4

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/pkcs/EncryptedData;->getContent()Lorg/bouncycastle/asn1/ASN1OctetString;
    ...
    invoke-virtual/range {v2 .. v7}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->cryptData(ZLorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[CZ[B)[B
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keyBag:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {v4, v3}, Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V

    invoke-static {v4}, Lorg/bouncycastle/jce/provider/JDKKeyFactory;->createPrivateKeyFromPrivateKeyInfo(Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;)Ljava/security/PrivateKey;
    ...
    iput-object v2, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certs:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;
    ...
    invoke-virtual {v14, v6}, Ljava/util/Vector;->elementAt(I)Ljava/lang/Object;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/asn1/pkcs/CertBag;->getCertId()Lorg/bouncycastle/asn1/DERObjectIdentifier;

    move-result-object v3

    sget-object v5, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->x509Certificate:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v3, v5}, Lorg/bouncycastle/asn1/DERObjectIdentifier;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v4, v3}, Lorg/bouncycastle/jce/interfaces/PKCS12BagAttributeCarrier;->getBagAttribute(Lorg/bouncycastle/asn1/DERObjectIdentifier;)Lorg/bouncycastle/asn1/DEREncodable;
    ...
    invoke-virtual {v4, v2}, Lorg/bouncycastle/asn1/DERObject;->equals(Ljava/lang/Object;)Z
    ...
    :cond_22
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->pkcs_9_at_friendlyName:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    iget-object v4, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->keys:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    const-string v5, "unmarked"

    invoke-virtual {v4, v5}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->remove(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v2, v0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certs:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    invoke-virtual {v2, v7, v5}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->put(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1, p2}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->put(Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->certs:Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;

    aget-object v2, p4, v0

    invoke-virtual {v1, p1, v2}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore$IgnoresCaseHashtable;->put(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public engineStore(Ljava/security/KeyStore$LoadStoreParameter;)V
    ...
    invoke-direct {p0, v2, v1, v0}, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->doStore(Ljava/io/OutputStream;[CZ)V
...
.method protected unwrapKey(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[B[CZ)Ljava/security/PrivateKey;
    ...
    :try_start_0
    sget-object v4, Lorg/bouncycastle/jce/provider/JDKPKCS12KeyStore;->bcProvider:Ljava/security/Provider;
