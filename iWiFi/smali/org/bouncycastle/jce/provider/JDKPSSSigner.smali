...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/jce/provider/JDKPSSSigner$NullPssDigest;,
        ...
        Lorg/bouncycastle/jce/provider/JDKPSSSigner$nonePSS;
    }
.end annotation
...
.method protected constructor <init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;Ljava/security/spec/PSSParameterSpec;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lorg/bouncycastle/jce/provider/JDKPSSSigner;-><init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;Ljava/security/spec/PSSParameterSpec;Z)V
...
.method protected constructor <init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;Ljava/security/spec/PSSParameterSpec;Z)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->paramSpec:Ljava/security/spec/PSSParameterSpec;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->mgfDigest:Lorg/bouncycastle/crypto/Digest;
    ...
    iput-boolean p3, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->isRaw:Z

    invoke-direct {p0}, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->setupContentDigest()V
...
.method private setupContentDigest()V
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->isRaw:Z

    if-eqz v0, :cond_0

    new-instance v0, Lorg/bouncycastle/jce/provider/JDKPSSSigner$NullPssDigest;

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->mgfDigest:Lorg/bouncycastle/crypto/Digest;

    invoke-direct {v0, p0, v1}, Lorg/bouncycastle/jce/provider/JDKPSSSigner$NullPssDigest;-><init>(Lorg/bouncycastle/jce/provider/JDKPSSSigner;Lorg/bouncycastle/crypto/Digest;)V

    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->contentDigest:Lorg/bouncycastle/crypto/Digest;

    :goto_0
    return-void

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->mgfDigest:Lorg/bouncycastle/crypto/Digest;
...
.method protected engineInitSign(Ljava/security/PrivateKey;)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->contentDigest:Lorg/bouncycastle/crypto/Digest;

    iget-object v3, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->mgfDigest:Lorg/bouncycastle/crypto/Digest;

    iget v4, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->saltLength:I

    iget-byte v5, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->trailer:B
...
.method protected engineSetParameter(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jce/provider/JDKPSSSigner;->mgfDigest:Lorg/bouncycastle/crypto/Digest;
