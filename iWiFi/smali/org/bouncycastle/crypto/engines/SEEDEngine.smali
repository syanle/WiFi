...
.method private createWorkingKey([B)[I
    ...
    invoke-direct {v0, v1, v2}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->bytesToLong([BI)J
    ...
    invoke-direct {v0, v9, v10}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v6

    move-object/from16 v0, p0

    invoke-direct {v0, v9, v10}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW1(J)I

    move-result v5

    move-object/from16 v0, p0

    invoke-direct {v0, v7, v8}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v4

    move-object/from16 v0, p0

    invoke-direct {v0, v7, v8}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW1(J)I
    ...
    sget-object v14, Lorg/bouncycastle/crypto/engines/SEEDEngine;->KC:[I
    ...
    invoke-direct {v0, v13}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->G(I)I
    ...
    invoke-direct {v0, v8, v9}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->rotateRight8(J)J

    move-result-wide v8

    move-object/from16 v0, p0

    invoke-direct {v0, v8, v9}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v5

    move-object/from16 v0, p0

    invoke-direct {v0, v8, v9}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW1(J)I
    ...
    invoke-direct {v0, v6, v7}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->rotateLeft8(J)J

    move-result-wide v6

    move-object/from16 v0, p0

    invoke-direct {v0, v6, v7}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v3

    move-object/from16 v0, p0

    invoke-direct {v0, v6, v7}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->extractW1(J)I
...
.method public processBlock([BI[BI)I
    ...
    iget-object v7, p0, Lorg/bouncycastle/crypto/engines/SEEDEngine;->wKey:[I
    ...
    invoke-direct {p0, v6, v7, v1, v2}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->F(IIJ)J
    ...
    invoke-direct {p0, v0, v5, v1, v2}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->longToBytes([BIJ)V

    add-int/lit8 v1, p4, 0x8

    move-object/from16 v0, p3

    invoke-direct {p0, v0, v1, v3, v4}, Lorg/bouncycastle/crypto/engines/SEEDEngine;->longToBytes([BIJ)V
