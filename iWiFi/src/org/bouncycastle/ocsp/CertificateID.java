...
public class CertificateID
{
    ...
    public CertificateID(String s, X509Certificate x509certificate, BigInteger biginteger, String s1)
        throws OCSPException
    {
        id = createCertID(new AlgorithmIdentifier(new DERObjectIdentifier(s), DERNull.INSTANCE), x509certificate, new DERInteger(biginteger), s1);
    }
    ...
    private static CertID createCertID(AlgorithmIdentifier algorithmidentifier, X509Certificate x509certificate, DERInteger derinteger, String s)
        throws OCSPException
    {
        try
        {
            ...
            algorithmidentifier = new CertID(algorithmidentifier, deroctetstring, new DEROctetString(s.digest()), derinteger);
        }
    ...
    public boolean equals(Object obj)
    {
        ...
        } else
        {
            ...
            return id.getDERObject().equals(((CertificateID) (obj)).id.getDERObject());
        }
    }
