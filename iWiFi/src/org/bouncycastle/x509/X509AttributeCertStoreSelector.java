    ...
    implements Selector
{
        ...
        throws IOException
    {
        ...
        for (collection = collection.iterator(); collection.hasNext();)
        {
            ...
            {
                hashset.add(GeneralName.getInstance(ASN1Object.fromByteArray((byte[])(byte[])obj)));
            }
        }
    ...
    public void addTargetGroup(byte abyte0[])
        throws IOException
    {
        addTargetGroup(GeneralName.getInstance(ASN1Object.fromByteArray(abyte0)));
    }
    ...
    public void addTargetName(byte abyte0[])
        throws IOException
    {
        addTargetName(GeneralName.getInstance(ASN1Object.fromByteArray(abyte0)));
    }
