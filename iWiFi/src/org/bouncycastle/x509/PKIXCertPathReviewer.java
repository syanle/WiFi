...
_L1:
        Object obj2;
        int j = n;
        obj2 = (X509Certificate)certs.get(i);
        if (isSelfIssued(((X509Certificate) (obj2)))) goto _L4; else goto _L3
_L3:
        Object obj1;
        Object obj3;
        obj1 = getSubjectPrincipal(((X509Certificate) (obj2)));
        obj3 = new ASN1InputStream(new ByteArrayInputStream(((X500Principal) (obj1)).getEncoded()));
        obj3 = (ASN1Sequence)((ASN1InputStream) (obj3)).readObject();
        ((PKIXNameConstraintValidator) (obj)).checkPermittedDN(((ASN1Sequence) (obj3)));
        ((PKIXNameConstraintValidator) (obj)).checkExcludedDN(((ASN1Sequence) (obj3)));
        obj3 = (ASN1Sequence)getExtensionValue(((java.security.cert.X509Extension) (obj2)), SUBJECT_ALTERNATIVE_NAME);
        if (obj3 == null) goto _L4; else goto _L5
_L5:
        int k = 0;
_L6:
        if (k >= ((ASN1Sequence) (obj3)).size())
        {
            break; /* Loop/switch isn't completed */
        }
        obj1 = GeneralName.getInstance(((ASN1Sequence) (obj3)).getObjectAt(k));
...
_L4:
        obj1 = (ASN1Sequence)getExtensionValue(((java.security.cert.X509Extension) (obj2)), NAME_CONSTRAINTS);
        if (obj1 == null)
        {
            break MISSING_BLOCK_LABEL_486;
        }
        obj1 = new NameConstraints(((ASN1Sequence) (obj1)));
        obj2 = ((NameConstraints) (obj1)).getPermittedSubtrees();
        if (obj2 == null)
        {
            break MISSING_BLOCK_LABEL_419;
        }
        ((PKIXNameConstraintValidator) (obj)).intersectPermittedSubtree(((ASN1Sequence) (obj2)));
        obj1 = ((NameConstraints) (obj1)).getExcludedSubtrees();
        if (obj1 == null)
        {
            break MISSING_BLOCK_LABEL_486;
        }
        for (obj1 = ((ASN1Sequence) (obj1)).getObjects(); ((Enumeration) (obj1)).hasMoreElements(); ((PKIXNameConstraintValidator) (obj)).addExcludedSubtree(GeneralSubtree.getInstance(((Enumeration) (obj1)).nextElement()))) { }
        break MISSING_BLOCK_LABEL_486;
...
_L5:
        ...
        derobjectidentifier = ((PolicyInformation) (obj8)).getPolicyIdentifier();
        ((Set) (obj2)).add(derobjectidentifier.getId());
        flag1 = "2.5.29.32.0".equals(derobjectidentifier.getId());
        if (flag1) goto _L8; else goto _L7
_L7:
        obj8 = getQualifierSet(((PolicyInformation) (obj8)).getPolicyQualifiers());
        if (!processCertD1i(l1, aarraylist, derobjectidentifier, ((Set) (obj8))))
        {
            processCertD1ii(l1, aarraylist, derobjectidentifier, ((Set) (obj8)));
        }
          goto _L8
_L10:
        return;
...
_L1:
        addError(new ErrorBundle("org.bouncycastle.x509.CertPathReviewerMessages", "CertPathReviewer.conflictingTrustAnchors", new Object[] {
            new Integer(((Collection) (obj)).size()), new UntrustedInput(((X509Certificate) (obj3)).getIssuerX500Principal())
        }));
        obj = null;
_L9:
        if (obj == null)
...
_L7:
        ...
        obj6 = null;
        derobject = getExtensionValue(x509certificate, AUTH_INFO_ACCESS);
...
_L2:
        ...
        addError(new ErrorBundle("org.bouncycastle.x509.CertPathReviewerMessages", "CertPathReviewer.noTrustAnchorFound", new Object[] {
            new UntrustedInput(((X509Certificate) (obj3)).getIssuerX500Principal()), new Integer(pkixParams.getTrustAnchors().size())
        }));
        obj = null;
          goto _L9
...
_L4:
        ...
        if (derobject != null)
        {
            try
            {
                obj5 = AuthorityInformationAccess.getInstance(derobject);
            }
            // Misplaced declaration of an exception variable
            catch (Object obj5)
            {
...
_L1:
        ...
        x509certificate = new ErrorBundle("org.bouncycastle.x509.CertPathReviewerMessages", "CertPathReviewer.QcLimitValueNum", new Object[] {
            new Integer(x509certificate.getCurrency().getNumeric()), new TrustedInput(new Double(d)), x509certificate
        });
          goto _L1
...
_L14:
        ...
        if (((X509CRL) (obj)).getNextUpdate() != null && !(new Date()).before(((X509CRL) (obj)).getNextUpdate())) goto _L5; else goto _L4
_L4:
...
_L3:
        ...
        addNotification(new ErrorBundle("org.bouncycastle.x509.CertPathReviewerMessages", "CertPathReviewer.noCrlInCertstore", new Object[] {
            new UntrustedInput(((X509CRLStoreSelector) (obj2)).getIssuerNames()), new UntrustedInput(obj3), new Integer(j)
        }), i);
        obj1 = obj;
          goto _L2
_L5:
...
_L15:
        k = j;
        if (!(new Date()).before(vector.getNextUpdate())) goto _L17; else goto _L16
_L16:
        k = 1;
        ...
        if (publickey != null)
        {
            ...
            if (obj != null)
            {
                ...
                if (((X509CRLEntry) (obj)).hasExtensions())
                {
                    ...
                    try
                    {
                        derenumerated = DEREnumerated.getInstance(getExtensionValue(((java.security.cert.X509Extension) (obj)), X509Extensions.ReasonCode.getId()));
                    }
                    // Misplaced declaration of an exception variable
                    catch (PKIXParameters pkixparameters)
                    {
                    ...
                    {
                        x509certificate1 = crlReasons[derenumerated.getValue().intValue()];
                    }
                }
            ...
            {
                if (vector.getNextUpdate() != null && vector.getNextUpdate().before(new Date()))
                {
...
_L7:
        ...
        throws CertPathReviewerException
    {
        ...
        authoritykeyidentifier = AuthorityKeyIdentifier.getInstance(ASN1Object.fromByteArray(((ASN1OctetString)ASN1Object.fromByteArray(abyte0)).getOctets()));
