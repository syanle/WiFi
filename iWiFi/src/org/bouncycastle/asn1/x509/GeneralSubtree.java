...
_L6:
        minimum = DERInteger.getInstance(asn1sequence, false);
_L2:
        return;
_L7:
        maximum = DERInteger.getInstance(asn1sequence, false);
        return;
_L4:
        ...
        minimum = DERInteger.getInstance(asn1taggedobject, false);
    ...
    public GeneralSubtree(GeneralName generalname, BigInteger biginteger, BigInteger biginteger1)
    {
        ...
        if (biginteger1 != null)
        {
            maximum = new DERInteger(biginteger1);
        }
        if (biginteger == null)
        {
            minimum = null;
        ...
        {
            minimum = new DERInteger(biginteger);
            return;
        }
    }
