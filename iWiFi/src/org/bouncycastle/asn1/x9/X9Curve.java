...
_L1:
        x9fieldid = ((DERInteger)x9fieldid.getParameters()).getValue();
...
_L2:
        ...
        {
            x9fieldid = (DERSequence)x9fieldid.getParameters();
            int l = ((DERInteger)x9fieldid.getObjectAt(0)).getValue().intValue();
            X9FieldElement x9fieldelement1;
            int i;
            int j;
            int k;
            if (((DERObjectIdentifier)x9fieldid.getObjectAt(1)).equals(tpBasis))
            {
                i = ((DERInteger)x9fieldid.getObjectAt(2)).getValue().intValue();
                k = 0;
                j = 0;
            } else
            {
                x9fieldid = (DERSequence)x9fieldid.getObjectAt(2);
                i = ((DERInteger)x9fieldid.getObjectAt(0)).getValue().intValue();
                j = ((DERInteger)x9fieldid.getObjectAt(1)).getValue().intValue();
                k = ((DERInteger)x9fieldid.getObjectAt(2)).getValue().intValue();
            }
...
_L3:
    ...
    public DERObject toASN1Object()
    {
        ...
        if (!fieldIdentifier.equals(prime_field)) goto _L2; else goto _L1
_L1:
        asn1encodablevector.add((new X9FieldElement(curve.getA())).getDERObject());
        asn1encodablevector.add((new X9FieldElement(curve.getB())).getDERObject());
_L4:
        if (seed != null)
        {
