...
public interface CryptoProObjectIdentifiers
{
    ...
    public static final DERObjectIdentifier gostR28147_cbc = new DERObjectIdentifier("1.2.643.2.2.21");
    ...
    public static final DERObjectIdentifier gostR3410_2001_CryptoPro_XchA = new DERObjectIdentifier("1.2.643.2.2.36.0");
    public static final DERObjectIdentifier gostR3410_2001_CryptoPro_XchB = new DERObjectIdentifier("1.2.643.2.2.36.1");
    ...
    public static final DERObjectIdentifier gostR3411 = new DERObjectIdentifier("1.2.643.2.2.9");
    public static final DERObjectIdentifier gostR3411_94_CryptoProParamSet = new DERObjectIdentifier("1.2.643.2.2.30.1");
    public static final DERObjectIdentifier gostR3411_94_with_gostR3410_2001 = new DERObjectIdentifier("1.2.643.2.2.3");
    public static final DERObjectIdentifier gostR3411_94_with_gostR3410_94 = new DERObjectIdentifier("1.2.643.2.2.4");
