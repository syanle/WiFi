...
public class PKIHeaderBuilder
{
    ...
    {
        this(new DERInteger(i), generalname, generalname1);
    }

    private PKIHeaderBuilder(DERInteger derinteger, GeneralName generalname, GeneralName generalname1)
    {
        pvno = derinteger;
        sender = generalname;
    ...
    {
        messageTime = dergeneralizedtime;
        return this;
    }
    ...
    {
        return setRecipKID(new DEROctetString(abyte0));
    }
    ...
    {
        return setRecipNonce(((ASN1OctetString) (new DEROctetString(abyte0))));
    }
    ...
    {
        return setSenderKID(((ASN1OctetString) (new DEROctetString(abyte0))));
    }
    ...
    {
        return setSenderNonce(((ASN1OctetString) (new DEROctetString(abyte0))));
    }
    ...
    {
        return setTransactionID(((ASN1OctetString) (new DEROctetString(abyte0))));
    }
}
