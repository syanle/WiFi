...
public interface PKCSObjectIdentifiers
{
    ...
    public static final ASN1ObjectIdentifier id_alg_PWRI_KEK = pkcs_9.branch("16.3.9");
    ...
    public static final ASN1ObjectIdentifier id_hmacWithSHA1 = digestAlgorithm.branch("7");
    public static final ASN1ObjectIdentifier id_hmacWithSHA224 = digestAlgorithm.branch("8");
    public static final ASN1ObjectIdentifier id_hmacWithSHA256 = digestAlgorithm.branch("9");
    public static final ASN1ObjectIdentifier id_hmacWithSHA384 = digestAlgorithm.branch("10");
    public static final ASN1ObjectIdentifier id_hmacWithSHA512 = digestAlgorithm.branch("11");
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_challengePassword = pkcs_9.branch("7");
    public static final ASN1ObjectIdentifier pkcs_9_at_contentType = pkcs_9.branch("3");
    public static final ASN1ObjectIdentifier pkcs_9_at_counterSignature = pkcs_9.branch("6");
    public static final ASN1ObjectIdentifier pkcs_9_at_emailAddress = pkcs_9.branch("1");
    public static final ASN1ObjectIdentifier pkcs_9_at_extendedCertificateAttributes = pkcs_9.branch("9");
    public static final ASN1ObjectIdentifier pkcs_9_at_extensionRequest = pkcs_9.branch("14");
    public static final ASN1ObjectIdentifier pkcs_9_at_friendlyName = pkcs_9.branch("20");
    public static final ASN1ObjectIdentifier pkcs_9_at_localKeyId = pkcs_9.branch("21");
    public static final ASN1ObjectIdentifier pkcs_9_at_messageDigest = pkcs_9.branch("4");
    public static final ASN1ObjectIdentifier pkcs_9_at_signingDescription = pkcs_9.branch("13");
    public static final ASN1ObjectIdentifier pkcs_9_at_signingTime = pkcs_9.branch("5");
    public static final ASN1ObjectIdentifier pkcs_9_at_smimeCapabilities = pkcs_9.branch("15");
    public static final ASN1ObjectIdentifier pkcs_9_at_unstructuredAddress = pkcs_9.branch("8");
    public static final ASN1ObjectIdentifier pkcs_9_at_unstructuredName = pkcs_9.branch("2");
    ...
    public static final ASN1ObjectIdentifier sdsiCertificate = certTypes.branch("2");
    ...
    public static final ASN1ObjectIdentifier x509Certificate = certTypes.branch("1");
    public static final ASN1ObjectIdentifier x509Crl = crlTypes.branch("1");
