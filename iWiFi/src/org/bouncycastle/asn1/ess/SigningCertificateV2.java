...
public class SigningCertificateV2 extends ASN1Encodable
{
    ...
    public static SigningCertificateV2 getInstance(Object obj)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("unknown object in 'SigningCertificateV2' factory : ").append(obj.getClass().getName()).append(".").toString());
        }
    }
