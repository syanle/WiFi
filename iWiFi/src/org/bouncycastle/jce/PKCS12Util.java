...
public class PKCS12Util
{
        ...
        throws IOException
    {
        ...
        abyte0 = new Pfx(ASN1Sequence.getInstance(ASN1Object.fromByteArray(abyte0)));
    ...
    public static byte[] convertToDefiniteLength(byte abyte0[], char ac[], String s)
        throws IOException
    {
        Object obj = new Pfx(ASN1Sequence.getInstance(ASN1Object.fromByteArray(abyte0)));
        ...
        try
        {
            ...
            ac = new MacData(new DigestInfo(new AlgorithmIdentifier(((MacData) (obj)).getMac().getAlgorithmId().getObjectId(), new DERNull()), ac), ((MacData) (obj)).getSalt(), i);
        }
