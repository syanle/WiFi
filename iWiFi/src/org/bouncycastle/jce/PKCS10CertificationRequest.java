...
public class PKCS10CertificationRequest extends CertificationRequest
{
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
        ...
        {
            sigAlgId = new AlgorithmIdentifier(derobjectidentifier, (DEREncodable)params.get(s2));
        } else
        {
        ...
        try
        {
            reqInfo = new CertificationRequestInfo(x509name, new SubjectPublicKeyInfo((ASN1Sequence)ASN1Object.fromByteArray(publickey.getEncoded())), asn1set);
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
    ...
    static String getSignatureName(AlgorithmIdentifier algorithmidentifier)
    {
        ...
        if (derencodable != null && !DERNull.INSTANCE.equals(derencodable) && algorithmidentifier.getObjectId().equals(PKCSObjectIdentifiers.id_RSASSA_PSS))
        {
            algorithmidentifier = RSASSAPSSparams.getInstance(derencodable);
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException
    {
        ...
        Object obj;
        obj = reqInfo.getSubjectPublicKeyInfo();
        x509encodedkeyspec = new X509EncodedKeySpec((new DERBitString(((DEREncodable) (obj)))).getBytes());
        obj = ((SubjectPublicKeyInfo) (obj)).getAlgorithmId();
        if (s != null)
        {
            break MISSING_BLOCK_LABEL_51;
        }
        return KeyFactory.getInstance(((AlgorithmIdentifier) (obj)).getObjectId().getId()).generatePublic(x509encodedkeyspec);
        PublicKey publickey = KeyFactory.getInstance(((AlgorithmIdentifier) (obj)).getObjectId().getId(), s).generatePublic(x509encodedkeyspec);
        return publickey;
...
_L2:
    ...
    static 
    {
        ...
        algorithmidentifier = new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha224, new DERNull());
        params.put("SHA224WITHRSAANDMGF1", creatPSSParams(algorithmidentifier, 28));
        algorithmidentifier = new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256, new DERNull());
        params.put("SHA256WITHRSAANDMGF1", creatPSSParams(algorithmidentifier, 32));
        algorithmidentifier = new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha384, new DERNull());
        params.put("SHA384WITHRSAANDMGF1", creatPSSParams(algorithmidentifier, 48));
        algorithmidentifier = new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha512, new DERNull());
