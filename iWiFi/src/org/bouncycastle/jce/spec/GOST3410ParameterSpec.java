    ...
    implements AlgorithmParameterSpec, GOST3410Params
{
    ...
    public GOST3410ParameterSpec(String s, String s1, String s2)
    {
        ...
        GOST3410ParamSetParameters gost3410paramsetparameters1 = GOST3410NamedParameters.getByOID(new DERObjectIdentifier(s));
...
_L1:
        ...
        DERObjectIdentifier derobjectidentifier = GOST3410NamedParameters.getOID(s);
        if (derobjectidentifier != null)
        {
            s = derobjectidentifier.getId();
            gost3410paramsetparameters = GOST3410NamedParameters.getByOID(derobjectidentifier);
        }
          goto _L1
    }
