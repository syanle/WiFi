...
_L7:
    ...
    private Set intersectDN(Set set, Set set1)
    {
        ...
        {
            ASN1Sequence asn1sequence = ASN1Sequence.getInstance(((GeneralSubtree)set1.next()).getBase().getName().getDERObject());
            if (set == null)
            {
...
_L3:
    ...
    public void addExcludedSubtree(GeneralSubtree generalsubtree)
    {
        ...
        case 4: // '\004'
            excludedSubtreesDN = unionDN(excludedSubtreesDN, (ASN1Sequence)generalsubtree.getName().getDERObject());
            return;
    ...
    public void intersectPermittedSubtree(ASN1Sequence asn1sequence)
    {
        ...
        Integer integer;
        for (asn1sequence = asn1sequence.getObjects(); asn1sequence.hasMoreElements(); ((Set)hashmap.get(integer)).add(generalsubtree))
        {
            generalsubtree = GeneralSubtree.getInstance(asn1sequence.nextElement());
            integer = new Integer(generalsubtree.getBase().getTagNo());
