...
public static class put extends HashMap
{
    ...
    public ()
    {
        ...
        put((new StringBuilder()).append("Cipher.").append(PKCSObjectIdentifiers.des_EDE3_CBC).toString(), "org.bouncycastle.jce.provider.symmetric.DESede$CBC");
        put((new StringBuilder()).append("Cipher.").append(OIWObjectIdentifiers.desCBC).toString(), "org.bouncycastle.jce.provider.symmetric.DESede$CBC");
        put("Cipher.DESEDEWRAP", "org.bouncycastle.jce.provider.symmetric.DESede$Wrap");
        put((new StringBuilder()).append("Cipher.").append(PKCSObjectIdentifiers.id_alg_CMS3DESwrap).toString(), "org.bouncycastle.jce.provider.symmetric.DESede$Wrap");
        ...
        put((new StringBuilder()).append("KeyGenerator.").append(PKCSObjectIdentifiers.des_EDE3_CBC).toString(), "org.bouncycastle.jce.provider.symmetric.DESede$KeyGenerator3");
