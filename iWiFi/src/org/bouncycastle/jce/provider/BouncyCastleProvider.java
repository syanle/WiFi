    ...
    implements ConfigurableProvider
{
    ...
    {
        super(PROVIDER_NAME, 1.46D, info);
    ...
    private void addHMACAlgorithm(String s, String s1, String s2)
    {
        String s3 = (new StringBuilder()).append("HMAC").append(s).toString();
        put((new StringBuilder()).append("Mac.").append(s3).toString(), s1);
        put((new StringBuilder()).append("Alg.Alias.Mac.HMAC-").append(s).toString(), s3);
        put((new StringBuilder()).append("Alg.Alias.Mac.HMAC/").append(s).toString(), s3);
        put((new StringBuilder()).append("KeyGenerator.").append(s3).toString(), s2);
        put((new StringBuilder()).append("Alg.Alias.KeyGenerator.HMAC-").append(s).toString(), s3);
        put((new StringBuilder()).append("Alg.Alias.KeyGenerator.HMAC/").append(s).toString(), s3);
    }

    private void addHMACAlias(String s, DERObjectIdentifier derobjectidentifier)
    {
        s = (new StringBuilder()).append("HMAC").append(s).toString();
        put((new StringBuilder()).append("Alg.Alias.Mac.").append(derobjectidentifier).toString(), s);
        put((new StringBuilder()).append("Alg.Alias.KeyGenerator.").append(derobjectidentifier).toString(), s);
    }
    ...
    private void addMappings(Map map)
    {
        ...
        for (Iterator iterator = map.keySet().iterator(); iterator.hasNext(); put(obj, map.get(obj)))
        {
            ...
            if (containsKey(obj))
            {
                throw new IllegalStateException((new StringBuilder()).append("duplicate provider key (").append(obj).append(") found in ").append(map.getClass().getName()).toString());
            }
        }
    ...
    private void addMessageDigestAlgorithms()
    {
        ...
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(OIWObjectIdentifiers.idSHA1).toString(), "SHA-1");
        put("MessageDigest.SHA-224", "org.bouncycastle.jce.provider.JDKMessageDigest$SHA224");
        put("Alg.Alias.MessageDigest.SHA224", "SHA-224");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(NISTObjectIdentifiers.id_sha224).toString(), "SHA-224");
        put("MessageDigest.SHA-256", "org.bouncycastle.jce.provider.JDKMessageDigest$SHA256");
        put("Alg.Alias.MessageDigest.SHA256", "SHA-256");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(NISTObjectIdentifiers.id_sha256).toString(), "SHA-256");
        put("MessageDigest.SHA-384", "org.bouncycastle.jce.provider.JDKMessageDigest$SHA384");
        put("Alg.Alias.MessageDigest.SHA384", "SHA-384");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(NISTObjectIdentifiers.id_sha384).toString(), "SHA-384");
        put("MessageDigest.SHA-512", "org.bouncycastle.jce.provider.JDKMessageDigest$SHA512");
        put("Alg.Alias.MessageDigest.SHA512", "SHA-512");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(NISTObjectIdentifiers.id_sha512).toString(), "SHA-512");
        put("MessageDigest.MD2", "org.bouncycastle.jce.provider.JDKMessageDigest$MD2");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(PKCSObjectIdentifiers.md2).toString(), "MD2");
        put("MessageDigest.MD4", "org.bouncycastle.jce.provider.JDKMessageDigest$MD4");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(PKCSObjectIdentifiers.md4).toString(), "MD4");
        put("MessageDigest.MD5", "org.bouncycastle.jce.provider.JDKMessageDigest$MD5");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(PKCSObjectIdentifiers.md5).toString(), "MD5");
        put("MessageDigest.RIPEMD128", "org.bouncycastle.jce.provider.JDKMessageDigest$RIPEMD128");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(TeleTrusTObjectIdentifiers.ripemd128).toString(), "RIPEMD128");
        put("MessageDigest.RIPEMD160", "org.bouncycastle.jce.provider.JDKMessageDigest$RIPEMD160");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(TeleTrusTObjectIdentifiers.ripemd160).toString(), "RIPEMD160");
        put("MessageDigest.RIPEMD256", "org.bouncycastle.jce.provider.JDKMessageDigest$RIPEMD256");
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(TeleTrusTObjectIdentifiers.ripemd256).toString(), "RIPEMD256");
        ...
        put((new StringBuilder()).append("Alg.Alias.MessageDigest.").append(CryptoProObjectIdentifiers.gostR3411).toString(), "GOST3411");
    }
    ...
    private void addSignatureAlgorithms()
    {
        ...
        put((new StringBuilder()).append("Signature.").append(PKCSObjectIdentifiers.id_RSASSA_PSS).toString(), "org.bouncycastle.jce.provider.JDKPSSSigner$PSSwithRSA");
        ...
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.md2WithRSAEncryption).toString(), "MD2WithRSAEncryption");
        ...
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.md5WithRSAEncryption).toString(), "MD5WithRSAEncryption");
        put("Alg.Alias.Signature.MD4WithRSA", "MD4WithRSAEncryption");
        put("Alg.Alias.Signature.MD4withRSA", "MD4WithRSAEncryption");
        put("Alg.Alias.Signature.MD4/RSA", "MD4WithRSAEncryption");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.md4WithRSAEncryption).toString(), "MD4WithRSAEncryption");
        ...
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.sha1WithRSAEncryption).toString(), "SHA1WithRSAEncryption");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.sha224WithRSAEncryption).toString(), "SHA224WithRSAEncryption");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.sha256WithRSAEncryption).toString(), "SHA256WithRSAEncryption");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.sha384WithRSAEncryption).toString(), "SHA384WithRSAEncryption");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(PKCSObjectIdentifiers.sha512WithRSAEncryption).toString(), "SHA512WithRSAEncryption");
        ...
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(OIWObjectIdentifiers.sha1WithRSA).toString(), "SHA1WithRSAEncryption");
        put("Alg.Alias.Signature.MD2WITHRSAENCRYPTION", "MD2WithRSAEncryption");
        put("Alg.Alias.Signature.MD5WITHRSAENCRYPTION", "MD5WithRSAEncryption");
        put("Alg.Alias.Signature.SHA1WITHRSAENCRYPTION", "SHA1WithRSAEncryption");
        put("Alg.Alias.Signature.RIPEMD160WITHRSAENCRYPTION", "RIPEMD160WithRSAEncryption");
        ...
        put("Alg.Alias.Signature.GOST3411WITHECGOST3410", "ECGOST3410");
        put("Alg.Alias.Signature.GOST3411WithECGOST3410", "ECGOST3410");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_2001).toString(), "ECGOST3410");
        ...
        put("Alg.Alias.Signature.GOST3411WITHGOST3410", "GOST3410");
        put("Alg.Alias.Signature.GOST3411WithGOST3410", "GOST3410");
        put((new StringBuilder()).append("Alg.Alias.Signature.").append(CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_94).toString(), "GOST3410");
    }
...
_L6:
        ...
        if (class1 != null)
        {
            try
            {
                addMappings((Map)class1.newInstance());
            }
...
_L2:
    ...
    private void setup()
    {
        loadAlgorithms("org.bouncycastle.jce.provider.symmetric.", SYMMETRIC_CIPHERS);
        loadAlgorithms("org.bouncycastle.jce.provider.asymmetric.", ASYMMETRIC_CIPHERS);
        ...
        put((new StringBuilder()).append("AlgorithmParameterGenerator.").append(PKCSObjectIdentifiers.des_EDE3_CBC).toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameterGenerator$DES");
        put((new StringBuilder()).append("AlgorithmParameterGenerator.").append(OIWObjectIdentifiers.desCBC).toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameterGenerator$DES");
        ...
        put((new StringBuilder()).append("AlgorithmParameters.").append(PKCSObjectIdentifiers.des_EDE3_CBC).toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameters$IVAlgorithmParameters");
        put((new StringBuilder()).append("AlgorithmParameters.").append(PKCSObjectIdentifiers.id_PBKDF2).toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameters$PBKDF2");
        ...
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc.getId()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc.getId()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc.getId()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc.getId()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc.getId()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc.getId()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(PKCSObjectIdentifiers.id_RSAES_OAEP).toString(), "OAEP");
        put("Alg.Alias.AlgorithmParameters.RSAPSS", "PSS");
        put("Alg.Alias.AlgorithmParameters.RSASSA-PSS", "PSS");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(PKCSObjectIdentifiers.id_RSASSA_PSS).toString(), "PSS");
        ...
        put((new StringBuilder()).append("Cipher.").append(OIWObjectIdentifiers.desCBC).toString(), "org.bouncycastle.jce.provider.JCEBlockCipher$DESCBC");
        ...
        put((new StringBuilder()).append("Cipher.").append(CryptoProObjectIdentifiers.gostR28147_cbc).toString(), "org.bouncycastle.jce.provider.JCEBlockCipher$GOST28147cbc");
        ...
        put((new StringBuilder()).append("Cipher.").append(PKCSObjectIdentifiers.id_RSAES_OAEP).toString(), "org.bouncycastle.jce.provider.JCERSACipher$OAEPPadding");
        ...
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc.getId()).toString(), "PBEWITHSHAAND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc.getId()).toString(), "PBEWITHSHAAND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc.getId()).toString(), "PBEWITHSHAAND256BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc.getId()).toString(), "PBEWITHSHA256AND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc.getId()).toString(), "PBEWITHSHA256AND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc.getId()).toString(), "PBEWITHSHA256AND256BITAES-CBC-BC");
        ...
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.pbeWithMD2AndDES_CBC).toString(), "PBEWITHMD2ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC).toString(), "PBEWITHMD2ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC).toString(), "PBEWITHSHA1ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC).toString(), "PBEWITHSHA1ANDRC2");
        ...
        put((new StringBuilder()).append("Alg.Alias.KeyGenerator.").append(OIWObjectIdentifiers.desCBC).toString(), "DES");
        ...
        put((new StringBuilder()).append("Alg.Alias.KeyGenerator.").append(CryptoProObjectIdentifiers.gostR28147_cbc).toString(), "GOST28147");
        ...
        put((new StringBuilder()).append("Alg.Alias.KeyFactory.").append(CryptoProObjectIdentifiers.gostR3410_94).toString(), "GOST3410");
        put("AlgorithmParameters.DES", "org.bouncycastle.jce.provider.JDKAlgorithmParameters$IVAlgorithmParameters");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(OIWObjectIdentifiers.desCBC).toString(), "DES");
        ...
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD2AndDES_CBC).toString(), "PBEWITHMD2ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC).toString(), "PBEWITHMD2ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC).toString(), "PBEWITHSHA1ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC).toString(), "PBEWITHSHA1ANDRC2");
        ...
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC).toString(), "PBEWITHMD2ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC).toString(), "PBEWITHMD5ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC).toString(), "PBEWITHSHA1ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC).toString(), "PBEWITHSHA1ANDRC2");
        ...
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc.getId()).toString(), "PBEWITHSHAAND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc.getId()).toString(), "PBEWITHSHAAND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc.getId()).toString(), "PBEWITHSHAAND256BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc.getId()).toString(), "PBEWITHSHA256AND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc.getId()).toString(), "PBEWITHSHA256AND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc.getId()).toString(), "PBEWITHSHA256AND256BITAES-CBC-BC");
        addMacAlgorithms();
    ...
    {
        ProviderUtil.setParameter(s, obj);
    }
