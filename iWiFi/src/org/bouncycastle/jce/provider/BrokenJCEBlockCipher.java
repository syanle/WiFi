...
//            BrokenPBE, BouncyCastleProvider, JCEPBEKey
...
label1:
            {
                ...
                {
                    key = BrokenPBE.Util.makePBEParameters((JCEPBEKey)key, algorithmparameterspec, pbeType, pbeHash, cipher.getUnderlyingCipher().getAlgorithmName(), pbeKeySize, pbeIvSize);
                    if (pbeIvSize != 0)
                    {
