    ...
    implements RSAPrivateCrtKey
{
    ...
    {
        modulus = rsaprivatekeystructure.getModulus();
        publicExponent = rsaprivatekeystructure.getPublicExponent();
        privateExponent = rsaprivatekeystructure.getPrivateExponent();
        primeP = rsaprivatekeystructure.getPrime1();
        primeQ = rsaprivatekeystructure.getPrime2();
        primeExponentP = rsaprivatekeystructure.getExponent1();
        primeExponentQ = rsaprivatekeystructure.getExponent2();
        crtCoefficient = rsaprivatekeystructure.getCoefficient();
    }
