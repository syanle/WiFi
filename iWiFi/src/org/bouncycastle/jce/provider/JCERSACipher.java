...
//            WrapCipherSpi, JCEDigestUtil, BouncyCastleProvider, RSAUtil
...
public class JCERSACipher extends WrapCipherSpi
{
        ...
        throws NoSuchPaddingException
    {
        ...
        org.bouncycastle.crypto.Digest digest = JCEDigestUtil.getDigest(mgf1parameterspec.getDigestAlgorithm());
        if (digest == null)
        {
        ...
        throws InvalidKeyException
    {
        ...
        {
            throw new RuntimeException((new StringBuilder()).append("Eeeek! ").append(key.toString()).toString(), key);
        }
    }
        ...
        throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        if (algorithmparameterspec == null || (algorithmparameterspec instanceof OAEPParameterSpec))
        {
            ...
            if (algorithmparameterspec != null)
            {
                ...
                algorithmparameterspec = JCEDigestUtil.getDigest(oaepparameterspec.getDigestAlgorithm());
                if (algorithmparameterspec == null)
                {
