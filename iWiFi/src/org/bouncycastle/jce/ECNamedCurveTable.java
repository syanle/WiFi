...
public class ECNamedCurveTable
{
    ...
    public static ECNamedCurveParameterSpec getParameterSpec(String s)
    {
        ...
        if (obj == null)
        {
            try
            {
                obj1 = X962NamedCurves.getByOID(new DERObjectIdentifier(s));
            }
        ...
        if (obj1 == null)
        {
            ...
            if (obj1 == null)
            {
                try
                {
                    obj = SECNamedCurves.getByOID(new DERObjectIdentifier(s));
                }
                // Misplaced declaration of an exception variable
                catch (Object obj)
                {
        ...
        if (obj == null)
        {
            ...
            if (obj == null)
            {
                try
                {
                    obj1 = TeleTrusTNamedCurves.getByOID(new DERObjectIdentifier(s));
                }
                // Misplaced declaration of an exception variable
                catch (Object obj1)
                {
