...
_L1:
        obj = ECUtil.getNamedCurveByOid((DERObjectIdentifier)((X962Parameters) (obj)).getParameters());
...
_L4:
        ...
        obj = new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ((X962Parameters) (obj)).getDERObject()), privatekeyinfo.getPrivateKey());
...
_L2:
        ...
        obj = new X9ECParameters(ProviderUtil.getEcImplicitlyCa().getCurve(), ProviderUtil.getEcImplicitlyCa().getG(), ProviderUtil.getEcImplicitlyCa().getN(), ProviderUtil.getEcImplicitlyCa().getH());
...
_L4:
        obj = new X962Parameters(((X9ECParameters) (obj)));
        obj = new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ((X962Parameters) (obj)).getDERObject()), subjectpublickeyinfo.getPublicKeyData().getBytes());
