    ...
    implements Text
{
    ...
    public DOMText(String s)
    {
        super(s);
    }

    public DOMText(Element element, String s)
    {
        super(element, s);
    }
    ...
    protected org.dom4j.Text createText(String s)
    {
        ...
        throws DOMException
    {
        ...
        setText(((String) (obj)));
        obj = getParent();
        obj1 = createText(((String) (obj1)));
        if (obj != null)
        {
            ((Element) (obj)).add(((org.dom4j.Text) (obj1)));
        }
