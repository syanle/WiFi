...
_L6:
        ...
        arraylist1 = arraylist;
        if (Session.isPublishPermission(s)) goto _L4; else goto _L3
_L3:
        if (!"basic_info".equals(s)) goto _L6; else goto _L5
_L5:
        return arraylist;
...
_L7:
    ...
    public static Exception getErrorFromResult(Intent intent)
    {
        ...
        intent = intent.getStringExtra("com.facebook.platform.status.ERROR_DESCRIPTION");
        if (s.equalsIgnoreCase("UserCanceled"))
        {
            return new FacebookOperationCanceledException(intent);
        } else
        {
            return new FacebookException(intent);
        }
    }
    ...
    {
        Object obj;
        obj = context.getContentResolver().query(PLATFORM_PROVIDER_VERSIONS_URI, new String[] {
            "version"
        }, null, null, null);
        if (obj == null)
        {
...
_L1:
        obj = KNOWN_PROTOCOL_VERSIONS.iterator();
_L4:
        Integer integer;
        ...
        continue; /* Loop/switch isn't completed */
_L2:
        context.add(Integer.valueOf(((Cursor) (obj)).getInt(((Cursor) (obj)).getColumnIndex("version"))));
        continue; /* Loop/switch isn't completed */
        if (!context.contains(integer)) goto _L4; else goto _L3
_L3:
...
_L2:
        ...
        do
        {
            ...
            if (context[j].toCharsString().equals(""))
            {
                continue;
            }
            j++;
