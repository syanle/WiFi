...
public class AllConfig
{
    ...
    public static final String Gasfilename = "gasstationlist";
    public static final String Gaspath = "/data/data/com.pubinfo.yixing_gasstation";
    ...
    public static final String SDICONPATH = "zfsoft/icon";
    public static final String SSIDLIST = "ssidlist";
    public static final String SSIDLIST_DATA = "data";
    public static final String SSIDLIST_TIME = "time";
    public static final String SSIDLIST_VERSION = "version";
