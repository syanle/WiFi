    ...
    implements PageIndicator
{
    ...
    {
        this(context, attributeset, 0x7f010000);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f0800d4);
        int k = ((Resources) (obj)).getColor(0x7f0800d3);
        int l = ((Resources) (obj)).getInteger(0x7f0b0000);
        int i1 = ((Resources) (obj)).getColor(0x7f0800d5);
        float f = ((Resources) (obj)).getDimension(0x7f090006);
        float f1 = ((Resources) (obj)).getDimension(0x7f090005);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f0a0000);
        boolean flag1 = ((Resources) (obj)).getBoolean(0x7f0a0001);
        attributeset = context.obtainStyledAttributes(attributeset, com.pubinfo.freewifialliance.R.styleable.CirclePageIndicator, i, 0);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (mViewPager != null)
        {
            if ((i1 = mViewPager.getAdapter().getCount()) != 0)
            {
                ...
                if (mCentered)
                {
                    f1 = f2 + ((float)(k - j - i) / 2.0F - ((float)i1 * f6) / 2.0F);
                }
                f3 = mRadius;
                f2 = f3;
                ...
                do
                {
                    ...
                    {
                        canvas.drawCircle(f4, f5, f2, mPaintPageFill);
                    }
                    if (f2 != mRadius)
                    {
                        canvas.drawCircle(f4, f5, mRadius, mPaintStroke);
                    }
                    i++;
                } while (true);
            }
