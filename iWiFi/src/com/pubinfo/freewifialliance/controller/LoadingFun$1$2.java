    ...
    class LoadingFun._cls1 extends Handler
    {
        ...
        public void handleMessage(final Message wifiDialog1)
        {
            ...
            case 4: // '\004'
                ...
                wifiDialog1.setOnWatchClickListener(new LoadingFun._cls1._cls1());
            ...
            case 5: // '\005'
                wifiDialog1 = new WifiDialog(LoadingFun.this, 0x7f070002);
                wifiDialog1.setOnWatchClickListener(wifiDialog1. new LoadingFun._cls1._cls2());
                wifiDialog1.setPoint(introfomation);
                wifiDialog1.show();
                return;
        ...
        // Unreferenced inner class com/pubinfo/freewifialliance/controller/LoadingFun$1$1

/* anonymous class */
        class LoadingFun._cls1._cls1
