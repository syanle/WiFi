...
public interface IILWAPIChannel
    extends IInterface
{
        ...
        implements IILWAPIChannel
    {
        ...
        public static IILWAPIChannel asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.laiwang.sdk.channel.IILWAPIChannel");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    lwapiaccount = (LWAPIAccount)LWAPIAccount.CREATOR.createFromParcel(parcel);
                } else
                {
                    lwapiaccount = null;
                }
                i = registerME(lwapiaccount, com.laiwang.sdk.openapi.IILWAPICallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readInt(), parcel.readString());
            ...
            case 3: // '\003'
                ...
                if (parcel.readInt() != 0)
                {
                    lwapiaccount1 = (LWAPIAccount)LWAPIAccount.CREATOR.createFromParcel(parcel);
                } else
                {
                    lwapiaccount1 = null;
                }
                if (parcel.readInt() != 0)
                {
                    lwmessage = (LWMessage)LWMessage.CREATOR.createFromParcel(parcel);
                } else
                {
                    lwmessage = null;
                }
            ...
            if (parcel.readInt() != 0)
            {
                lwapiaccount2 = (LWAPIAccount)LWAPIAccount.CREATOR.createFromParcel(parcel);
            } else
            {
                lwapiaccount2 = null;
            }
...
_L2:
    ...
    public abstract int introduceMe(String s)
        throws RemoteException;

    public abstract int registerME(LWAPIAccount lwapiaccount, IILWAPICallback iilwapicallback, int i, String s)
        throws RemoteException;

    public abstract int requestData(LWAPIAccount lwapiaccount, Bundle bundle, int i)
        throws RemoteException;

    public abstract int transportData(LWAPIAccount lwapiaccount, LWMessage lwmessage, int i)
        throws RemoteException;
}
