...
public interface IILWAPICallback
    extends IInterface
{
        ...
        implements IILWAPICallback
    {
        ...
        public static IILWAPICallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.laiwang.sdk.openapi.IILWAPICallback");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (LWMessage)LWMessage.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
...
_L1:
    ...
    public abstract int onDisplay(LWMessage lwmessage)
        throws RemoteException;

    public abstract int onLWAPICallback(int i)
        throws RemoteException;
}
