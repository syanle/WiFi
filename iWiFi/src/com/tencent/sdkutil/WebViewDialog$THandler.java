...
_L4:
        ...
        {
            WebViewDialog.access$200((Context)WebViewDialog.access$100().get(), (String)message.obj);
            return;
        }
...
_L6:
        if (WebViewDialog.access$100() != null && WebViewDialog.access$100().get() != null)
        {
            WebViewDialog.access$400((Context)WebViewDialog.access$100().get(), (String)message.obj);
            return;
        }
