...
class z extends UMAsyncTask
{
    ...
    z(c c1, com.umeng.socialize.controller.listener.SocializeListeners.SocializeClientListener socializeclientlistener, b b1, Context context)
    {
        a = c1;
