    ...
    implements com.umeng.socialize.controller.listener.SocializeListeners.UMDataListener
{
    ...
    n(c c1, Context context, SHARE_MEDIA share_media, com.umeng.socialize.controller.listener.SocializeListeners.SnsPostListener snspostlistener)
    {
        a = c1;
        b = context;
        c = share_media;
    ...
    public void onComplete(int i, Map map)
    {
        ...
        {
            Log.e(com.umeng.socialize.controller.impl.c.a(), "\u65E0\u6CD5\u83B7\u53D6AppId");
            return;
        }
    }
