...
public class DownloadingService extends Service
{
    ...
    class b extends Thread
    {
        ...
        {
            Log.b(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder("can not install. ")).append(exception.getMessage()).toString());
            if (i != null)
            {
                i.a(h, exception);
            }
            com.umeng.socom.net.DownloadingService.a(a, j, e, f, d);
        }

        private void a(boolean flag)
        {
            Object obj1 = (new StringBuilder(String.valueOf(com.umeng.socom.util.g.a(j.c)))).append(".apk.tmp").toString();
            if (!DeviceConfig.isSdCardWrittenable()) goto _L2; else goto _L1
_L1:
            Object obj;
            Object obj2;
...
_L8:
            Object obj3;
            Log.c(com.umeng.socom.net.DownloadingService.a(), String.format("saveAPK: url = %1$15s\t|\tfilename = %2$15s", new Object[] {
            ...
            obj6 = obj;
            obj5 = obj1;
            Log.c(com.umeng.socom.net.DownloadingService.a(), String.format("getContentLength: %1$15s", new Object[] {
                Long.valueOf(f)
            }));
            obj6 = obj;
            obj5 = obj1;
            ...
            obj6 = obj;
            obj5 = obj1;
            Log.c(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder(String.valueOf(j.b))).append("saveAPK getContentLength ").append(String.valueOf(f)).toString());
            obj6 = obj;
            obj5 = obj1;
            com.umeng.socom.net.c.a(b).a(j.a, j.c);
_L35:
            obj6 = obj;
            obj5 = obj1;
...
_L6:
            obj6 = obj;
            obj5 = obj1;
            obj2 = (d)com.umeng.socom.net.DownloadingService.c().get(Integer.valueOf(h));
            obj6 = obj;
            obj5 = obj1;
            ((d) (obj2)).f[0] = e;
            obj6 = obj;
...
_L5:
            ...
            obj6 = obj;
            obj5 = obj1;
            if (com.umeng.socom.net.DownloadingService.b().get(j) == null)
            {
                break MISSING_BLOCK_LABEL_772;
            }
            obj6 = obj;
            obj5 = obj1;
            ((Messenger)com.umeng.socom.net.DownloadingService.b().get(j)).send(Message.obtain(null, 3, j1, 0));
_L11:
            obj6 = obj;
            obj5 = obj1;
            com.umeng.socom.net.c.a(b).a(j.a, j.c, j1);
            break MISSING_BLOCK_LABEL_2284;
            obj5;
            obj6 = obj;
            obj5 = obj1;
            Log.b(com.umeng.socom.net.DownloadingService.a(), String.format("Service Client for downloading %1$15s is dead. Removing messenger from the service", new Object[] {
                j.b
            }));
            obj6 = obj;
            obj5 = obj1;
            com.umeng.socom.net.DownloadingService.b().put(j, null);
            if (true) goto _L11; else goto _L10
_L10:
            obj2;
_L34:
            Log.c(com.umeng.socom.net.DownloadingService.a(), ((IOException) (obj2)).getMessage(), ((Exception) (obj2)));
            i1 = d + 1;
            d = i1;
...
_L14:
            Log.b(com.umeng.socom.net.DownloadingService.a(), "Download Fail out of max repeat count");
            ((Messenger)com.umeng.socom.net.DownloadingService.b().get(j)).send(Message.obtain(null, 5, 0, 0));
            com.umeng.socom.net.DownloadingService.a(a, h);
            a(((Exception) (obj2)));
            com.umeng.socom.net.DownloadingService.c(a).post(new j(this));
_L23:
            if (obj1 == null)
            {
...
_L7:
            ...
            obj6 = obj;
            obj5 = obj1;
            com.umeng.socom.net.DownloadingService.b(a).cancel(h);
            if (obj1 == null)
            {
                continue; /* Loop/switch isn't completed */
            }
...
_L19:
            ...
            obj6 = obj;
            obj5 = obj1;
            Log.b(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder("Download Fail repeat count=")).append(d).toString());
            obj6 = obj;
            obj5 = obj1;
            ((Messenger)com.umeng.socom.net.DownloadingService.b().get(j)).send(Message.obtain(null, 5, 0, 0));
            obj6 = obj;
...
_L21:
            ...
            obj6 = obj;
            obj5 = obj1;
            abyte0.put("dtime", com.umeng.socom.util.g.a().split(" ")[1]);
            obj6 = obj;
            obj5 = obj1;
            abyte0.put("ptimes", String.valueOf(d));
            obj6 = obj;
            obj5 = obj1;
            com.umeng.socom.net.DownloadingService.a(abyte0, true, j.d);
            obj6 = obj;
            obj5 = obj1;
...
_L32:
            ...
            throw obj4;
_L13:
            Log.c(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder("wait for repeating Test network repeat count=")).append(d).toString());
...
_L25:
            ...
            ((d) (obj2)).f[1] = f;
            ((d) (obj2)).f[2] = d;
            obj2 = com.umeng.socom.net.l.a(h, "continue");
            Intent intent = new Intent(b, com/umeng/socom/net/DownloadingService);
            intent.putExtra("com.umeng.broadcast.download.msg", ((String) (obj2)));
            com.umeng.socom.net.DownloadingService.a(a, b, intent);
            a.a(b.getString(com.umeng.socom.b.a(b).f("Download_info_interrupt")));
            Log.c(com.umeng.socom.net.DownloadingService.a(), "changed play state button on op-notification.");
              goto _L23
            obj1;
            ((IOException) (obj1)).printStackTrace();
...
_L4:
        ...
        public void run()
        {
            ...
            {
                a(flag);
                if (com.umeng.socom.net.DownloadingService.b().size() <= 0)
                {
                    a.stopSelf();
                }
                return;
        ...
        public b(Context context, a.a a1, int i1, int j1, a a2)
        {
            ...
            j = a1;
            d = j1;
            if (!com.umeng.socom.net.DownloadingService.c().containsKey(Integer.valueOf(i1)))
            {
                break MISSING_BLOCK_LABEL_109;
            }
            downloadingservice = ((d)com.umeng.socom.net.DownloadingService.c().get(Integer.valueOf(i1))).f;
...
_L1:
            ...
            {
                Log.c(com.umeng.socom.net.DownloadingService.a(), getMessage(), DownloadingService.this);
    ...
    class c extends Handler
    {
        ...
        {
            Log.c(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder("IncomingHandler(msg.what:")).append(message.what).append(" msg.arg1:").append(message.arg1).append(" msg.arg2:").append(message.arg2).append(" msg.replyTo:").append(message.replyTo).toString());
            Object obj;
            switch (message.what)
            {
            default:
            ...
            Log.c(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder("IncomingHandler(msg.getData():")).append(obj).toString());
            obj = com.umeng.socom.net.a.a.a(((Bundle) (obj)));
            if (com.umeng.socom.net.DownloadingService.b(((a.a) (obj))))
            {
                Log.a(com.umeng.socom.net.DownloadingService.a(), (new StringBuilder(String.valueOf(((a.a) (obj)).b))).append(" is already in downloading list. ").toString());
                Toast.makeText(com.umeng.socom.net.DownloadingService.a(a), com.umeng.socom.b.a(com.umeng.socom.net.DownloadingService.a(a)).f("umeng_common_action_info_exist"), 0).show();
                return;
            } else
            {
                com.umeng.socom.net.DownloadingService.b().put(obj, message.replyTo);
                com.umeng.socom.net.DownloadingService.a(a, ((a.a) (obj)));
                return;
            }
        }
    ...
    private static class d
    {
        ...
        public void a()
        {
            com.umeng.socom.net.DownloadingService.c().put(Integer.valueOf(c), this);
        }

        public void b()
        {
            if (com.umeng.socom.net.DownloadingService.c().containsKey(Integer.valueOf(c)))
            {
                com.umeng.socom.net.DownloadingService.c().remove(Integer.valueOf(c));
            }
        }
    ...
    private static final String j = com/umeng/socom/net/DownloadingService.getName();
    ...
    private Notification a(a.a a1, int i1, int j1)
    {
        ...
        RemoteViews remoteviews = new RemoteViews(context.getPackageName(), com.umeng.socom.a.b.a(context));
        remoteviews.setProgressBar(com.umeng.socom.a.a.c(context), 100, j1, false);
        remoteviews.setTextViewText(com.umeng.socom.a.a.b(context), (new StringBuilder(String.valueOf(j1))).append("%").toString());
        remoteviews.setTextViewText(com.umeng.socom.a.a.d(context), (new StringBuilder(String.valueOf(context.getResources().getString(com.umeng.socom.a.c.g(context.getApplicationContext()))))).append(a1.b).toString());
        remoteviews.setTextViewText(com.umeng.socom.a.a.a(context), "");
        remoteviews.setImageViewResource(com.umeng.socom.a.a.e(context), 0x1080081);
        notification.contentView = remoteviews;
        notification.contentIntent = PendingIntent.getActivity(context, 0, new Intent(), 0x8000000);
        if (a1.e)
        {
            notification.flags = 2;
            a1 = com.umeng.socom.net.l.b(getApplicationContext(), com.umeng.socom.net.l.a(i1, "continue"));
            remoteviews.setOnClickPendingIntent(com.umeng.socom.a.a.f(context), a1);
            remoteviews.setViewVisibility(com.umeng.socom.a.a.f(context), 0);
            b(notification, i1);
            a1 = com.umeng.socom.net.l.b(getApplicationContext(), com.umeng.socom.net.l.a(i1, "cancel"));
            remoteviews.setViewVisibility(com.umeng.socom.a.a.h(context), 0);
            remoteviews.setOnClickPendingIntent(com.umeng.socom.a.a.h(context), a1);
            return notification;
        } else
        {
            notification.flags = 16;
            remoteviews.setViewVisibility(com.umeng.socom.a.a.f(context), 8);
            remoteviews.setViewVisibility(com.umeng.socom.a.a.h(context), 8);
            return notification;
        }
    }
    ...
    {
        int j1 = com.umeng.socom.a.a.f(m);
        notification.contentView.setTextViewText(j1, m.getResources().getString(com.umeng.socom.a.c.e(m.getApplicationContext())));
        notification.contentView.setInt(j1, "setBackgroundResource", com.umeng.socom.b.a(m).c("umeng_common_gradient_green"));
    ...
    private void a(a.a a1, long l1, long l2, long l3)
    {
        if (a1.d != null)
        {
            ...
            hashmap.put("dtime", com.umeng.socom.util.g.a().split(" ")[1]);
            float f1 = 0.0F;
            if (l2 > 0L)
            {
...
_L3:
        ...
        Toast.makeText(context, context.getResources().getString(com.umeng.socom.a.c.a(context.getApplicationContext())), 1).show();
        return false;
...
_L2:
    ...
    {
        int j1 = com.umeng.socom.a.a.f(m);
        notification.contentView.setTextViewText(j1, m.getResources().getString(com.umeng.socom.a.c.d(m.getApplicationContext())));
        notification.contentView.setInt(j1, "setBackgroundResource", com.umeng.socom.b.a(m).c("umeng_common_gradient_orange"));
        k.notify(i1, notification);
    }
...
_L7:
    ...
    public void a(String s1)
    {
        synchronized (t)
        {
            if (!t.booleanValue())
            {
                ...
                n.post(new com.umeng.socom.net.g(this, s1));
    ...
    public void onCreate()
    {
        ...
        m = this;
        n = new com.umeng.socom.net.d(this);
        o = new e(this);
    }
    ...
    public void onDestroy()
    {
        try
        {
            com.umeng.socom.net.c.a(getApplicationContext()).a(0x3f480);
            com.umeng.socom.net.c.a(getApplicationContext()).finalize();
            if (s != null)
            {
