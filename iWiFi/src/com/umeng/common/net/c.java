...
public class c
{
    ...
    public void a(int l)
    {
        try
        {
            ...
            s = (new StringBuilder()).append(" DELETE FROM umeng_download_task_list WHERE strftime('yyyy-MM-dd HH:mm:ss', last_modified)<=strftime('yyyy-MM-dd HH:mm:ss', '").append(s).append("')").toString();
            k.getWritableDatabase().execSQL(s);
            Log.c(a, (new StringBuilder()).append("clearOverdueTasks(").append(l).append(")").append(" remove all tasks before ").append((new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(date)).toString());
            return;
        }
    ...
    public void a(String s, String s1, int l)
    {
        ...
        contentvalues.put("last_modified", com.umeng.common.util.h.a());
        k.getWritableDatabase().update("umeng_download_task_list", contentvalues, "cp=? and url=?", new String[] {
            s, s1
        });
        Log.c(a, (new StringBuilder()).append("updateProgress(").append(s).append(", ").append(s1).append(", ").append(l).append(")").toString());
    }
    ...
    public void a(String s, String s1, String s2)
    {
        ...
        Log.c(a, (new StringBuilder()).append("updateExtra(").append(s).append(", ").append(s1).append(", ").append(s2).append(")").toString());
    }
...
_L1:
        Log.c(a, (new StringBuilder()).append("insert(").append(s).append(", ").append(s1).append("): ").append(" already exists in the db. Insert is cancelled.").toString());
        boolean flag = false;
_L4:
        cursor.close();
        return flag;
_L2:
        ...
        try
        {
            Log.c(a, (new StringBuilder()).append("insert(").append(s).append(", ").append(s1).append("): ").append("rowid=").append(l).toString());
        }
...
_L3:
        ...
        flag = false;
_L6:
        Log.c(a, (new StringBuilder()).append("insert(").append(s).append(", ").append(s1).append("): ").append(exception.getMessage()).toString(), exception);
        return flag;
        exception;
...
_L5:
    ...
    public Date d(String s, String s1)
    {
        ...
        if (cursor.getCount() > 0)
        {
            ...
            Log.c(a, (new StringBuilder()).append("getLastModified(").append(s).append(", ").append(s1).append("): ").append(((String) (obj))).toString());
            try
            {
    ...
    public void e(String s, String s1)
    {
        ...
        Log.c(a, (new StringBuilder()).append("delete(").append(s).append(", ").append(s1).append(")").toString());
    }
