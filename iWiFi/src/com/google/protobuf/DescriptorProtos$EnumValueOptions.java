...
public static final class memoizedSerializedSize extends 
    implements rBuilder
{
        ...
        implements DescriptorProtos.EnumValueOptionsOrBuilder
    {
        ...
        {
            DescriptorProtos.EnumValueOptions enumvalueoptions = new DescriptorProtos.EnumValueOptions(this, null);
            int i = bitField0_;
            if (uninterpretedOptionBuilder_ == null)
            {
                if ((bitField0_ & 1) == 1)
...
_L3:
    ...
    protected e internalGetFieldAccessorTable()
    {
        return DescriptorProtos.access$14800();
    }
...
/*
    static List access$15302(Builder builder, List list)
    {
