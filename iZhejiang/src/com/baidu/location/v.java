...
class v
{
    ...
    public static String a(Context context)
    {
        ...
        try
        {
            context = context.getPackageManager().getApplicationInfo(((String) (obj)), 128).metaData.getString("com.baidu.lbsapi.API_KEY");
        }
        ...
        context1 = context;
        obj = Pattern.compile("[&=]").matcher(context).replaceAll("");
        return ((String) (obj));
    }
