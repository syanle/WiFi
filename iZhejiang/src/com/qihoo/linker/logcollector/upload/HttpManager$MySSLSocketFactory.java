...
private static class sslContext extends SSLSocketFactory
{
    ...
    public _cls1.this._cls1(KeyStore keystore)
        throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        ...
        keystore = new X509TrustManager() {
            ...
            final HttpManager.MySSLSocketFactory this$1;
            ...
            {
                this$1 = HttpManager.MySSLSocketFactory.this;
                super();
            }
        };
