...
class val.secret extends Thread
{
    ...
    public void run()
    {
        ...
        accountID = SDKCommonMotheds.getDevidOrPltCodeFromUrl(((String) (obj1)), "platform_code=");
        obj = accountID;
        if (accountID == null)
        {
            obj = "";
        ...
        accountID = URLEncoder.encode(((String) (obj1)));
        ...
        as1 = DoAuthenticationLogoffOperation.access$2(DoAuthenticationLogoffOperation.this).sync_getTempToken(val$phoneNum, val$appversion, ((String) (obj2)), s3, s4, ((String) (dev_id)), s, val$app_id, ((String) (obj)), accountID, val$appkey, val$secret);
        ...
        if ("AP_AUTH".equals(s5))
        {
            ...
            dev_id = DoAuthenticationLogoffOperation.access$2(DoAuthenticationLogoffOperation.this).AP_sync_LoginAuthen(s, val$phoneNum, s2, "android", ((String) (dev_id)), accountID, "http://www.baidu.com");
            int i;
        ...
        if ("AAA_AUTH".equals(s5))
        {
            ...
            obj = new WifiAuthenticationProcedure(DoAuthenticationLogoffOperation.access$1(DoAuthenticationLogoffOperation.this), new WifiAuthenticationRequestCallback() {
                ...
                public void onAuthenticationRequestFailure(String s6)
                {
                    ...
                    message2.what = 1;
                    s6 = DoAuthenticationLogoffOperation.access$2(this$0).generateAuthResultJson(s6, "AAA_AUTH", dev_id, null, "", null, accountID, "");
                    message2.obj = s6;
        ...
        if ("AC_AUTH".equals(s5) || "BAS_AUTH".equals(s5) || "FIT_AP_AUTH".equals(s5) || "VLAN_AUTH".equals(s5))
        {
            ...
            obj = DoAuthenticationLogoffOperation.access$2(DoAuthenticationLogoffOperation.this).AC_sync_LoginAuthen((new StringBuilder(String.valueOf(val$phoneNum))).append("@51iwifi.com").toString(), ((String) (dev_id)), s2, s3, s, accountID, ((String) (obj)));
        ...
        if ("THIRD_AUTH".equals(s5))
        {
            ...
            obj = DoAuthenticationLogoffOperation.access$2(DoAuthenticationLogoffOperation.this).Third_sync_LoginAuthen(val$phoneNum, ((String) (dev_id)), val$appversion, ((String) (obj2)), s3, s4, s2, ((String) (obj)), accountID, URLEncoder.encode(s1), val$appkey, val$secret);
            if (((sultInfo) (obj)).auth_status)
            {
                k = 0;
            } else
        ...
        } else
        {
            ...
            message1.what = 1;
            message1.obj = DoAuthenticationLogoffOperation.access$2(DoAuthenticationLogoffOperation.this).generateJson("FAIL", (new StringBuilder("Unkown authen type: ")).append(s5).toString(), s5, ((String) (dev_id)), ((String) (obj)), "", "", null, null, accountID, "");
