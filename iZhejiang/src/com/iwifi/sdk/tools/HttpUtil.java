...
_L2:
        ...
        if ("getPortalUrl".equals(s1))
        {
            s = (new StringBuilder(String.valueOf(s))).append(s2).append("?").append(s3).toString();
        } else
        {
            s = (new StringBuilder(String.valueOf(s))).append(s1).append(s2).append("?").append(s3).toString();
        }
        ...
        {
            s.setHeader("User-Agent", iWiFi_SECOND_AGENT);
        }
        ((DefaultHttpClient)s2).setRedirectHandler(new RedirectHandler() {
            ...
            public boolean isRedirectRequested(HttpResponse httpresponse, HttpContext httpcontext)
            {
                ...
                Logger.i("Portal StatusCode", (new StringBuilder()).append(j).toString());
                j;
...
_L3:
        ...
        if (!"smartwifi/auth".equals(s1) && !"getPortalUrl".equals(s1)) goto _L5; else goto _L4
_L16:
        if (!"getPortalUrl".equals(s1) || mRedirectUrl != null || !s.getFirstHeader("Content-type").getValue().startsWith("text/html")) goto _L7; else goto _L6
_L6:
        s = SDKCommonMotheds.JSoupHTMLParse(s.getEntity().getContent());
        Logger.i("iWiFiSDK|Common API|HttpUtils", (new StringBuilder("iWiFi20_METHOD_GETPORTAL HTTP Requst Parse HTML: ")).append(s.toString()).append(i).toString());
        s2 = GetChinaNetRedirectUrl(s);
        if (s2 == null) goto _L9; else goto _L8
_L8:
        mRedirectUrl = s2;
        Logger.i("iWiFiSDK", (new StringBuilder(" iWiFi20_METHOD_GETPORTAL  --- get ChinaNet RedirectUrl success:   ")).append(mRedirectUrl).append(i).toString());
_L7:
        if (!"smartwifi/auth".equals(s1) || !isApLogoffOperation(s3)) goto _L11; else goto _L10
_L10:
        if (i != 200) goto _L13; else goto _L12
_L12:
        s = generateJsonResult("AP Logoff suceess", (new StringBuilder()).append(i).toString());
_L15:
        mStrResult = s;
        mRedirectUrl = null;
        return;
_L3:
        ...
        if (i != 0)
        {
            s5 = (new StringBuilder(String.valueOf(s3))).append("&").toString();
        }
        s3 = (new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf(s5))).append(((DataObject)list.get(i)).getKey()).toString()))).append("=").toString()))).append(((DataObject)list.get(i)).getValue()).toString();
        i++;
          goto _L14
_L9:
        try
        {
            s2 = GetFujianRedirectUrl(s);
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
        ...
        mRedirectUrl = s2;
        Logger.i("iWiFiSDK", (new StringBuilder(" iWiFi20_METHOD_GETPORTAL  --- get Fujian RedirectUrl success:   ")).append(mRedirectUrl).append(i).toString());
          goto _L7
        s2 = GetOtherRedirectUrl(s, "a", "href");
        if (s2 == null)
        {
...
_L17:
        ...
        mRedirectUrl = null;
          goto _L7
_L13:
        s = generateJsonResult(null, (new StringBuilder("AP Logoff Failed, http status code is ")).append(i).toString());
          goto _L15
_L11:
        s = generateJsonResult(mRedirectUrl, (new StringBuilder()).append(i).toString());
          goto _L15
_L5:
        mStrResult = EntityUtils.toString(s.getEntity());
        return;
_L4:
        if (i != 200 && i != 100) goto _L17; else goto _L16
    }
    ...
    private String generateJsonResult(String s, String s1)
    {
        if (s == null || s.equals(""))
        {
            return (new StringBuilder("{\"result\":\"FAIL\",\"message\":\"")).append(s1).append("\"}").toString();
        } else
        {
    ...
    private boolean isApLogoffOperation(String s)
    {
        return s != null && s.contains("logout=1");
    }
