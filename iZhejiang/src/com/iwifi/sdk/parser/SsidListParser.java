...
public class SsidListParser
{
    ...
    public static Object SsidList(String s, String s1, String s2, String s3, String s4, String s5)
        throws Exception
    {
        SsidList ssidlist = new SsidList();
        JSONObject jsonobject = new JSONObject(s);
        ...
        do
        {
            if (i >= s3.length() - 1)
            {
                ...
                ssidlist.setVersion(jsonobject.getString(s5));
                ssidlist.setMsg(jsonobject.getString(s2));
                ssidlist.setResult(jsonobject.getString(s1));
                ssidlist.setCode(jsonobject.getString(s4));
                return ssidlist;
            }
