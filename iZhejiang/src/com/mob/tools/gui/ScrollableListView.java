    ...
    implements Scrollable
{
    ...
    private void init(Context context)
    {
        ...
        setDividerHeight(0);
        osListener = new Scrollable.OnScrollListener() {
...
/*
    static boolean access$002(ScrollableListView scrollablelistview, boolean flag)
    {
        scrollablelistview.pullEnable = flag;
        return flag;
    }
