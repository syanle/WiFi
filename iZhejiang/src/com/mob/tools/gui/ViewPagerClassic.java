...
_L4:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        {
            int l = getChildCount();
            int i1 = android.view.View.MeasureSpec.makeMeasureSpec(R.getScreenWidth(getContext()), 0x40000000);
            j = 0;
            i = 0;
            for (; j < l; j++)
            {
...
_L6:
    ...
    public void setCurrentScreen(int i)
    {
        ...
        i = R.getScreenWidth(getContext()) * currentScreen;
