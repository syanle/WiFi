...
class this._cls0
    implements android.os.Activity._cls6
{
...
_L4:
        if ((new StringBuilder("\"")).append(ssidclick).append("\"").toString().equals(ssidconnect) || ssidclick.equals(ssidconnect))
        {
            ...
            if (startTime == 0L || !ssidclick.equals(message))
            {
                ...
                message.commit();
                ConnectActivity.access$11(ConnectActivity.this, new Runnable() {

                    final ConnectActivity._cls6 this$1;

                    public void run()
                    {
                        String s1 = showTimeCount(System.currentTimeMillis() - startTime);
                        tv2.setText(s1);
