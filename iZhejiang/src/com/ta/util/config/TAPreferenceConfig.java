...
public class TAPreferenceConfig
    implements TAIConfig
{
    ...
    {
        edit = null;
        filename = "thinkandroid";
        isLoad = Boolean.valueOf(false);
        mContext = context;
    }
...
_L2:
    ...
    public void loadConfig()
    {
        try
        {
            mSharedPreferences = mContext.getSharedPreferences(filename, 2);
            edit = mSharedPreferences.edit();
            isLoad = Boolean.valueOf(true);
            return;
        }
