...
public class AsyncHttpResponseHandler
{
    ...
    protected void handleMessage(Message message)
    {
        ...
        case 0: // '\0'
            ...
            handleProgressMessage(((Long)message[0]).longValue(), ((Long)message[1]).longValue(), ((Long)message[2]).longValue());
            return;

        case 4: // '\004'
            message = ((Message) ((Object[])message.obj));
            handleSuccessMessage(((Integer)message[0]).intValue(), (Header[])message[1], (String)message[2]);
            return;
    ...
    protected void handleProgressMessage(long l, long l1, long l2)
    {
        onProgress(l, l1, l2);
    }
