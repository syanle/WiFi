    ...
    extends IInterface
{
        ...
        implements IDownloadService
    {
        ...
        public static IDownloadService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.ta.util.download.IDownloadService");
    ...
    public abstract void addTask(String s)
        throws RemoteException;

    public abstract void continueTask(String s)
        throws RemoteException;

    public abstract void deleteTask(String s)
        throws RemoteException;

    public abstract void pauseAll(String s)
        throws RemoteException;

    public abstract void pauseTask(String s)
        throws RemoteException;

    public abstract void startManage()
        throws RemoteException;

    public abstract void stopManage()
        throws RemoteException;
}
