...
public class TAPropertiesOperateUtils
{
    ...
    public TAPropertiesOperateUtils(Context context, String s)
    {
        mContext = context;
        properFile = new File(s);
    }
    ...
    private Properties getPro()
    {
        ...
        try
        {
            properties.load(new FileInputStream(properFile));
        }
    ...
    private void setProperties(Properties properties)
    {
        try
        {
            FileOutputStream fileoutputstream = new FileOutputStream(properFile, false);
