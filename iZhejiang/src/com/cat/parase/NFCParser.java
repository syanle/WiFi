...
public class NFCParser
{
    ...
    public static Object NFCparser(String s)
        throws Exception
    {
        Object obj;
...
_L2:
        ...
        nfc = new NFC();
        nfc.setAppid(jsonobject1.getString("appid"));
        nfc.setSeqid(jsonobject1.getString("seqid"));
        nfc.setRandom(jsonobject1.getString("random"));
        s.add(nfc);
        i++;
