...
public class YixinMoments extends Platform
{
    ...
    public static final String NAME = cn/sharesdk/yixin/moments/YixinMoments.getSimpleName();
    private String a;
    private boolean b;
...
_L3:
    ...
    protected void initDevInfo(String s)
    {
        ...
        {
            a = getDevinfo("Yixin", "AppId");
            if (a != null && a.length() > 0)
            {
                copyDevinfo("Yixin", NAME);
                a = getDevinfo("AppId");
                b = "true".equals(getDevinfo("BypassApproval"));
                if (ShareSDK.isDebug())
                {
    ...
    public boolean isClientValid()
    {
        ...
        yixinimpl.a(context, a);
        return yixinimpl.b() && yixinimpl.c();
    }
    ...
    protected void setNetworkDevinfo()
    {
        ...
        if (a == null || a.length() <= 0)
        {
            a = getNetworkDevinfo(38, "app_id", "AppId");
            if (a != null && a.length() > 0)
            {
                copyNetworkDevinfo(38, 39);
                a = getNetworkDevinfo("app_id", "AppId");
                if (ShareSDK.isDebug())
                {
                    System.err.println("Try to use the dev info of Yixin, this will cause Id and SortId field are always 0.");
