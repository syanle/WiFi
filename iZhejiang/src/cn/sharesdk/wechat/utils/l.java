    ...
    implements android.os.Handler.Callback
{
    ...
    final Platform e;
    final HashMap f;
    final WechatHelper g;

    l(WechatHelper wechathelper, DeviceHelper devicehelper, String s, PlatformActionListener platformactionlistener, Platform platform, HashMap hashmap)
    {
        g = wechathelper;
        b = devicehelper;
        c = s;
