    ...
    extends IInterface
{
        ...
        implements ServiceAIDL
    {
        ...
        public static ServiceAIDL asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("cn.com.chinatelecom.ctpass.aidl.ServiceAIDL");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                registerCallback(AIDLCallback.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("cn.com.chinatelecom.ctpass.aidl.ServiceAIDL");
                unregisterCallback(AIDLCallback.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract void connectCTPassService()
        throws RemoteException;

    public abstract String getCTPassToken(String s, String s1, String s2)
        throws RemoteException;

    public abstract String getCTPassTokenByPassword(String s, String s1, String s2, String s3)
        throws RemoteException;

    public abstract String getOTP(int i)
        throws RemoteException;

    public abstract String getOTPByPassword(int i, String s)
        throws RemoteException;

    public abstract String queryPasswordStatus()
        throws RemoteException;

    public abstract void registerCallback(AIDLCallback aidlcallback)
        throws RemoteException;

    public abstract void unregisterCallback(AIDLCallback aidlcallback)
        throws RemoteException;

    public abstract String updatePassword(String s, String s1)
        throws RemoteException;
}
