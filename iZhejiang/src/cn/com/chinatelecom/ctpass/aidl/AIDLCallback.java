    ...
    extends IInterface
{
        ...
        implements AIDLCallback
    {
        ...
        public static AIDLCallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("cn.com.chinatelecom.ctpass.aidl.AIDLCallback");
    ...
    public abstract void connectCTPassServiceCallBack(String s)
        throws RemoteException;
}
