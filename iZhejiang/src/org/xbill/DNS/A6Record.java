...
public class A6Record extends Record
{
    ...
    private static final long serialVersionUID = 0x85aabbbffebd791bL;
    private Name prefix;
        ...
        throws IOException
    {
        ...
        if (prefixBits < 128)
        {
            ...
            {
                throw tokenizer.exception((new StringBuilder("invalid IPv6 address: ")).append(s).toString());
            }
        }
        if (prefixBits > 0)
        {
