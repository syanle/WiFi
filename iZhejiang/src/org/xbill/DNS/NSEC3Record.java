...
public class NSEC3Record extends Record
{
    ...
    private static final long serialVersionUID = 0x9d243a4689393409L;
    private int flags;
    private int hashAlg;
        ...
        throws NoSuchAlgorithmException
    {
        ...
        {
        default:
            throw new NoSuchAlgorithmException((new StringBuilder("Unknown NSEC3 algorithmidentifier: ")).append(i).toString());
