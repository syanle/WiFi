...
public class SIGRecord extends SIGBase
{
    ...
    private static final long serialVersionUID = 0x44e217f07be03542L;

    SIGRecord()
    {
    }

    public SIGRecord(Name name, int i, long l, int j, int k, long l1, Date date, Date date1, int i1, Name name1, byte abyte0[])
    {
        super(name, 24, i, l, j, k, l1, date, date1, i1, name1, abyte0);
    }
