...
public class CERTRecord extends Record
{
    ...
    public static final int SPKI = 2;
    public static final int URI = 253;
    private static final long serialVersionUID = 0x4219a095e1a12903L;
    private int alg;
    private byte cert[];
        ...
        throws IOException
    {
        ...
        certType = CertificateType.value(name);
        if (certType < 0)
        {
            throw tokenizer.exception((new StringBuilder("Invalid certificate type: ")).append(name).toString());
        }
