    ...
    implements co
{
    ...
    {
        return (tring)Enum.valueOf(u/aly/av$e, s);
    }
    ...
    static 
    {
        a = new <init>("NAME", 0, (short)1, "name");
        b = new <init>("PROPERTIES", 1, (short)2, "properties");
        c = new <init>("DURATION", 2, (short)3, "duration");
        d = new <init>("ACC", 3, (short)4, "acc");
        e = new <init>("TS", 4, (short)5, "ts");
        i = (new i[] {
            a, b, c, d, e
        });
        f = new HashMap();
        terator terator;
        for (Iterator iterator = EnumSet.allOf(u/aly/av$e).iterator(); iterator.hasNext(); f.put(terator.b(), terator))
        {
