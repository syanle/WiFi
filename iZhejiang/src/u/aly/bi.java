...
_L2:
            ...
            if (db1.b == 0)
            {
                ...
                if (!bi1.e())
                {
                    throw new dh((new StringBuilder()).append("Required field 'height' was not found in serialized data! Struct: ").append(((Object)this).toString()).toString());
                }
...
_L1:
            ...
            if (!bi1.i())
            {
                throw new dh((new StringBuilder()).append("Required field 'width' was not found in serialized data! Struct: ").append(((Object)this).toString()).toString());
            } else
            {
                bi1.j();
                return;
        ...
        implements co
    {
        ...
        {
            return (e)Enum.valueOf(u/aly/bi$e, s);
        }
        ...
        static 
        {
            ...
            c = new HashMap();
            e e1;
            for (Iterator iterator = EnumSet.allOf(u/aly/bi$e).iterator(); iterator.hasNext(); c.put(e1.b(), e1))
            {
                e1 = (e)iterator.next();
            }
    ...
    static 
    {
        ...
        EnumMap enummap = new EnumMap(u/aly/bi$e);
        enummap.put(e.a, new ct("height", (byte)1, new cu((byte)8)));
        enummap.put(e.b, new ct("width", (byte)1, new cu((byte)8)));
