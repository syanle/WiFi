...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;,
        Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowListItem;,
        Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$PRTHeader;,
        Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$RotateImageView;
    }
.end annotation

.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lcn/sharesdk/onekeyshare/FollowerListFakeActivity;",
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 115
    iget-object v3, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->llTitle:Lcn/sharesdk/framework/TitleLayout;
    ...
    invoke-virtual {v3}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;->getCount()I
...
.method public onCreate()V
    ...
    .line 59
    iget-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->activity:Landroid/app/Activity;
    ...
    iput-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->llTitle:Lcn/sharesdk/framework/TitleLayout;
    ...
    invoke-static {v8, v9}, Lcom/mob/tools/utils/R;->getBitmapRes(Landroid/content/Context;Ljava/lang/String;)I
    ...
    .line 65
    iget-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->llTitle:Lcn/sharesdk/framework/TitleLayout;
    ...
    .line 90
    new-instance v1, Lcom/mob/tools/gui/PullToRefreshView;

    invoke-virtual {p0}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->getContext()Landroid/content/Context;

    move-result-object v8

    invoke-direct {v1, v8}, Lcom/mob/tools/gui/PullToRefreshView;-><init>(Landroid/content/Context;)V

    .line 91
    .local v1, "followList":Lcom/mob/tools/gui/PullToRefreshView;
    ...
    invoke-virtual {v1, v5}, Lcom/mob/tools/gui/PullToRefreshView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 94
    invoke-virtual {v0, v1}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    .line 95
    new-instance v8, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;

    invoke-direct {v8, v1}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;-><init>(Lcom/mob/tools/gui/PullToRefreshView;)V

    iput-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->adapter:Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;

    .line 96
    iget-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->adapter:Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;

    iget-object v9, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->platform:Lcn/sharesdk/framework/Platform;

    invoke-virtual {v8, v9}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;->setPlatform(Lcn/sharesdk/framework/Platform;)V

    .line 97
    iget-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->adapter:Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;

    invoke-virtual {v1, v8}, Lcom/mob/tools/gui/PullToRefreshView;->setAdapter(Lcom/mob/tools/gui/PullToRefreshAdatper;)V

    .line 98
    iget-object v8, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->adapter:Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;

    invoke-virtual {v8}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;->getListView()Landroid/widget/ListView;
    ...
    .line 111
    invoke-virtual {v1, v12}, Lcom/mob/tools/gui/PullToRefreshView;->performPulling(Z)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 130
    iget-object v4, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->platform:Lcn/sharesdk/framework/Platform;
    ...
    invoke-virtual {p0, v2}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->isRadioMode(Ljava/lang/String;)Z
    ...
    .line 132
    iget v4, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->lastPosition:I

    if-ltz v4, :cond_0

    .line 133
    iget-object v4, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->adapter:Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;

    iget v5, p0, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage;->lastPosition:I

    invoke-virtual {v4, v5}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;->getItem(I)Lcn/sharesdk/onekeyshare/FollowerListFakeActivity$Following;
    ...
    invoke-virtual {v4, p3}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;->getItem(I)Lcn/sharesdk/onekeyshare/FollowerListFakeActivity$Following;
    ...
    invoke-virtual {v3}, Lcn/sharesdk/onekeyshare/theme/classic/FollowListPage$FollowAdapter;->notifyDataSetChanged()V
