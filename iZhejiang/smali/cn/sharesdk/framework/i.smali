...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcn/sharesdk/framework/i;->a:Z
...
.method private d(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    const-string v3, "cn.sharesdk.system.bluetooth.Bluetooth"
    ...
    const-string v3, "cn.sharesdk.laiwang.friends.Laiwang"

    aput-object v3, v2, v1

    const/16 v1, 0x26

    const-string v3, "cn.sharesdk.laiwang.moments.LaiwangMoments"
...
.method public a(Landroid/content/Context;Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lcn/sharesdk/framework/statistics/a;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method public a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lcn/sharesdk/framework/statistics/a;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ZILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v5}, Lcn/sharesdk/framework/statistics/a;->a(Ljava/lang/String;Ljava/lang/String;IZLjava/lang/String;)Ljava/lang/String;
...
.method public a(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    sget-boolean v0, Lcn/sharesdk/framework/i;->a:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lcn/sharesdk/framework/i;->d(Landroid/content/Context;)Ljava/util/ArrayList;

    move-result-object v0

    :goto_0
    invoke-virtual {p0, v0}, Lcn/sharesdk/framework/i;->a(Ljava/util/ArrayList;)V

    :goto_1
    return-object v0

    :cond_0
    invoke-direct {p0, p1}, Lcn/sharesdk/framework/i;->c(Landroid/content/Context;)Landroid/content/pm/PackageInfo;
    ...
    :cond_1
    invoke-direct {p0, v0, p1}, Lcn/sharesdk/framework/i;->a(Landroid/content/pm/PackageInfo;Landroid/content/Context;)Ljava/util/ArrayList;
...
.method public a(ILcn/sharesdk/framework/Platform;)V
    ...
    new-instance v0, Lcn/sharesdk/framework/statistics/b/d;

    invoke-direct {v0}, Lcn/sharesdk/framework/statistics/b/d;-><init>()V
    ...
    iput v1, v0, Lcn/sharesdk/framework/statistics/b/d;->b:I

    :cond_0
    const/4 v1, 0x0

    invoke-static {v1}, Lcn/sharesdk/framework/statistics/b;->a(Landroid/content/Context;)Lcn/sharesdk/framework/statistics/b;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1, v0}, Lcn/sharesdk/framework/statistics/b;->a(Lcn/sharesdk/framework/statistics/b/c;)V
    ...
    iput-object v1, v0, Lcn/sharesdk/framework/statistics/b/d;->a:Ljava/lang/String;
...
.method public a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Handler;ZI)V
    ...
    invoke-static {p1}, Lcn/sharesdk/framework/statistics/b;->a(Landroid/content/Context;)Lcn/sharesdk/framework/statistics/b;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcn/sharesdk/framework/statistics/b;->a(Ljava/lang/String;)V

    invoke-virtual {v0, p3}, Lcn/sharesdk/framework/statistics/b;->a(Landroid/os/Handler;)V

    invoke-virtual {v0, p4}, Lcn/sharesdk/framework/statistics/b;->a(Z)V

    invoke-virtual {v0, p5}, Lcn/sharesdk/framework/statistics/b;->a(I)V

    invoke-virtual {v0}, Lcn/sharesdk/framework/statistics/b;->startThread()V
...
.method public a(Ljava/lang/String;I)V
    ...
    invoke-static {v0}, Lcn/sharesdk/framework/statistics/b;->a(Landroid/content/Context;)Lcn/sharesdk/framework/statistics/b;
    ...
    :cond_0
    new-instance v1, Lcn/sharesdk/framework/statistics/b/a;

    invoke-direct {v1}, Lcn/sharesdk/framework/statistics/b/a;-><init>()V

    iput-object p1, v1, Lcn/sharesdk/framework/statistics/b/a;->b:Ljava/lang/String;

    iput p2, v1, Lcn/sharesdk/framework/statistics/b/a;->a:I

    invoke-virtual {v0, v1}, Lcn/sharesdk/framework/statistics/b;->a(Lcn/sharesdk/framework/statistics/b/c;)V
...
.method public a(Ljava/util/ArrayList;)V
    ...
    invoke-direct {v0, p0}, Lcn/sharesdk/framework/j;-><init>(Lcn/sharesdk/framework/i;)V
...
.method public b(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Lcn/sharesdk/framework/statistics/b;->stopThread()V
