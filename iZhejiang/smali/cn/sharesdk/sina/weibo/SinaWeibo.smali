...
.method static synthetic a(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method private a(Lcn/sharesdk/framework/Platform$ShareParams;)V
    ...
    iget-object v3, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->c:Ljava/lang/String;

    invoke-direct {v1, p0, v2, v3}, Lcn/sharesdk/sina/weibo/a;-><init>(Lcn/sharesdk/framework/Platform;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->listener:Lcn/sharesdk/framework/PlatformActionListener;

    iget-boolean v3, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->d:Z

    invoke-virtual {v1, v2, p1, v3}, Lcn/sharesdk/sina/weibo/a;->a(Lcn/sharesdk/framework/PlatformActionListener;Lcn/sharesdk/framework/Platform$ShareParams;Z)V

    invoke-virtual {p0}, Lcn/sharesdk/sina/weibo/SinaWeibo;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v1, v2, v0}, Lcn/sharesdk/sina/weibo/a;->show(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private a([Ljava/lang/String;)V
    ...
    new-instance v0, Lcn/sharesdk/sina/weibo/a;
    ...
    invoke-direct {v0, p0, v1, v2}, Lcn/sharesdk/sina/weibo/a;-><init>(Lcn/sharesdk/framework/Platform;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, Lcn/sharesdk/sina/weibo/d;

    invoke-direct {v1, p0}, Lcn/sharesdk/sina/weibo/d;-><init>(Lcn/sharesdk/sina/weibo/SinaWeibo;)V

    invoke-virtual {p0}, Lcn/sharesdk/sina/weibo/SinaWeibo;->isSSODisable()Z

    move-result v2

    invoke-virtual {v0, v1, p1, v2}, Lcn/sharesdk/sina/weibo/a;->a(Lcn/sharesdk/framework/PlatformActionListener;[Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v2, v1}, Lcn/sharesdk/sina/weibo/a;->show(Landroid/content/Context;Landroid/content/Intent;)V

    return-void
.end method

.method static synthetic b(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method private b(Lcn/sharesdk/framework/Platform$ShareParams;)V
    ...
    :goto_0
    invoke-static {p0}, Lcn/sharesdk/sina/weibo/i;->a(Lcn/sharesdk/framework/Platform;)Lcn/sharesdk/sina/weibo/i;
    ...
    invoke-virtual {v0}, Lcn/sharesdk/sina/weibo/i;->a()Z
    ...
    invoke-virtual {v0, v1, p1, v2}, Lcn/sharesdk/sina/weibo/i;->a(Ljava/lang/String;Lcn/sharesdk/framework/Platform$ShareParams;Lcn/sharesdk/framework/PlatformActionListener;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v0 .. v5}, Lcn/sharesdk/sina/weibo/i;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;FF)Ljava/util/HashMap;
...
.method static synthetic b(Lcn/sharesdk/sina/weibo/SinaWeibo;ILjava/lang/Object;)V
    .locals 0
...
.method private b([Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcn/sharesdk/sina/weibo/i;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcn/sharesdk/sina/weibo/i;->a(Ljava/lang/String;)V

    invoke-virtual {v0, p1}, Lcn/sharesdk/sina/weibo/i;->a([Ljava/lang/String;)V

    new-instance v1, Lcn/sharesdk/sina/weibo/e;

    invoke-direct {v1, p0, v0}, Lcn/sharesdk/sina/weibo/e;-><init>(Lcn/sharesdk/sina/weibo/SinaWeibo;Lcn/sharesdk/sina/weibo/i;)V

    invoke-virtual {p0}, Lcn/sharesdk/sina/weibo/SinaWeibo;->isSSODisable()Z

    move-result v2

    invoke-virtual {v0, v1, v2}, Lcn/sharesdk/sina/weibo/i;->a(Lcn/sharesdk/framework/authorize/AuthorizeListener;Z)V

    return-void
.end method

.method static synthetic c(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method static synthetic d(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method static synthetic g(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformDb;
    .locals 1
...
.method static synthetic h(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformDb;
    .locals 1
...
.method static synthetic i(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformDb;
    .locals 1
...
.method static synthetic k(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method static synthetic l(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method static synthetic m(Lcn/sharesdk/sina/weibo/SinaWeibo;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1
...
.method protected checkAuthorize(ILjava/lang/Object;)Z
    ...
    const-string v6, "cn.sharesdk.sina.weibo.SinaActivity"
    ...
    const-string v3, "cn.sharesdk.sina.weibo.SinaActivity is not registered"
    ...
    invoke-virtual {v3}, Lcn/sharesdk/sina/weibo/i;->a()Z
    ...
    iget-boolean v0, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->d:Z
    ...
    iget-object v0, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->a:Ljava/lang/String;

    iget-object v2, p0, Lcn/sharesdk/sina/weibo/SinaWeibo;->b:Ljava/lang/String;

    invoke-virtual {v3, v0, v2}, Lcn/sharesdk/sina/weibo/i;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcn/sharesdk/sina/weibo/i;->b(Ljava/lang/String;)V
...
.method protected doAuthorize([Ljava/lang/String;)V
    ...
    const-string v1, "cn.sharesdk.sina.weibo.SinaActivity is not registered"
    ...
    invoke-direct {p0, p1}, Lcn/sharesdk/sina/weibo/SinaWeibo;->b([Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcn/sharesdk/sina/weibo/SinaWeibo;->a([Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
...
.method protected doCustomerProtocol(Ljava/lang/String;Ljava/lang/String;ILjava/util/HashMap;Ljava/util/HashMap;)V
    ...
    invoke-virtual {v0, p1, p2, p4, p5}, Lcn/sharesdk/sina/weibo/i;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;Ljava/util/HashMap;)Ljava/util/HashMap;
...
.method protected doShare(Lcn/sharesdk/framework/Platform$ShareParams;)V
    ...
    invoke-direct {p0, p1}, Lcn/sharesdk/sina/weibo/SinaWeibo;->b(Lcn/sharesdk/framework/Platform$ShareParams;)V
    ...
    :cond_1
    :try_start_1
    const-string v0, "com.sina.weibo.sdk.api.share.WeiboShareSDK"

    invoke-static {v0}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;

    invoke-direct {p0, p1}, Lcn/sharesdk/sina/weibo/SinaWeibo;->a(Lcn/sharesdk/framework/Platform$ShareParams;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
...
.method protected follow(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1}, Lcn/sharesdk/sina/weibo/i;->d(Ljava/lang/String;)Ljava/util/HashMap;
...
.method protected getFriendList(IILjava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1, p2, p3}, Lcn/sharesdk/sina/weibo/i;->b(IILjava/lang/String;)Ljava/util/HashMap;
...
.method protected timeline(IILjava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1, p2, p3}, Lcn/sharesdk/sina/weibo/i;->a(IILjava/lang/String;)Ljava/util/HashMap;
...
.method protected userInfor(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1}, Lcn/sharesdk/sina/weibo/i;->c(Ljava/lang/String;)Ljava/util/HashMap;
