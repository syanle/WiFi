.class public Lcom/cat/parase/ApInfoParser;
.super Ljava/lang/Object;
.source "ApInfoParser.java"
...
.method public static Apinfoparaser(Ljava/lang/String;)Ljava/lang/Object;
    .locals 13
    ...
    .line 40
    .local v9, "ld":Ljava/util/List;, "Ljava/util/List<Lcom/cat/data/ApInfoData;>;"
    ...
    new-instance v10, Lcom/cat/data/ApInfoData;

    invoke-direct {v10}, Lcom/cat/data/ApInfoData;-><init>()V

    .line 44
    .local v10, "mb":Lcom/cat/data/ApInfoData;
    ...
    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setMac(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setName(Ljava/lang/String;)V

    .line 46
    const-string v11, "connects"

    invoke-virtual {v8, v11}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setConnects(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setLoad(Ljava/lang/String;)V

    .line 49
    const-string v11, "currentconnect"

    invoke-virtual {v8, v11}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setCurrentconnect(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setNettype(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setLogo(Ljava/lang/String;)V

    .line 52
    const-string v11, "appraisal"

    invoke-virtual {v8, v11}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v10, v11}, Lcom/cat/data/ApInfoData;->setAppraisal(Ljava/lang/String;)V
    ...
    .end local v9    # "ld":Ljava/util/List;, "Ljava/util/List<Lcom/cat/data/ApInfoData;>;"
    .end local v10    # "mb":Lcom/cat/data/ApInfoData;
    :catch_0
    move-exception v0
