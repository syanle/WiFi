.class public Lcom/ta/util/http/PersistentCookieStore;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v6, p0, Lcom/ta/util/http/PersistentCookieStore;->cookiePrefs:Landroid/content/SharedPreferences;
    ...
    iput-object v6, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;

    .line 63
    iget-object v6, p0, Lcom/ta/util/http/PersistentCookieStore;->cookiePrefs:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0, v5}, Lcom/ta/util/http/PersistentCookieStore;->clearExpired(Ljava/util/Date;)Z
    ...
    iget-object v7, p0, Lcom/ta/util/http/PersistentCookieStore;->cookiePrefs:Landroid/content/SharedPreferences;
    ...
    .line 69
    invoke-virtual {p0, v2}, Lcom/ta/util/http/PersistentCookieStore;->decodeCookie(Ljava/lang/String;)Lorg/apache/http/cookie/Cookie;
    ...
    .line 71
    iget-object v7, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public addCookie(Lorg/apache/http/cookie/Cookie;)V
    ...
    .line 87
    iget-object v2, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 93
    :goto_0
    iget-object v2, p0, Lcom/ta/util/http/PersistentCookieStore;->cookiePrefs:Landroid/content/SharedPreferences;
    ...
    iget-object v4, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    new-instance v3, Lcom/ta/util/http/SerializableCookie;

    invoke-direct {v3, p1}, Lcom/ta/util/http/SerializableCookie;-><init>(Lorg/apache/http/cookie/Cookie;)V

    invoke-virtual {p0, v3}, Lcom/ta/util/http/PersistentCookieStore;->encodeCookie(Lcom/ta/util/http/SerializableCookie;)Ljava/lang/String;
...
.method public clearExpired(Ljava/util/Date;)Z
    ...
    iget-object v5, p0, Lcom/ta/util/http/PersistentCookieStore;->cookiePrefs:Landroid/content/SharedPreferences;
    ...
    iget-object v5, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 123
    iget-object v6, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;
...
.method protected decodeCookie(Ljava/lang/String;)Lorg/apache/http/cookie/Cookie;
    ...
    .prologue
    .line 165
    invoke-virtual {p0, p1}, Lcom/ta/util/http/PersistentCookieStore;->hexStringToByteArray(Ljava/lang/String;)[B
    ...
    check-cast v5, Lcom/ta/util/http/SerializableCookie;

    invoke-virtual {v5}, Lcom/ta/util/http/SerializableCookie;->getCookie()Lorg/apache/http/cookie/Cookie;
    :try_end_0
...
.method protected encodeCookie(Lcom/ta/util/http/SerializableCookie;)Ljava/lang/String;
    .locals 4
    .param p1, "cookie"    # Lcom/ta/util/http/SerializableCookie;
    ...
    invoke-virtual {p0, v3}, Lcom/ta/util/http/PersistentCookieStore;->byteArrayToHexString([B)Ljava/lang/String;
...
.method public getCookies()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/ta/util/http/PersistentCookieStore;->cookies:Ljava/util/concurrent/ConcurrentHashMap;
