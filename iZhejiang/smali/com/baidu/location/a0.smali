...
.method public for(Ljava/lang/String;Z)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/baidu/location/m;->a(Landroid/content/Context;)Lcom/baidu/location/m;

    move-result-object v1

    invoke-virtual {v1}, Lcom/baidu/location/m;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    const-string v5, "SELECT distinct b.geofence_id, b.longitude, b.latitude, b.radius, b.coord_type, b.duration_millis, b.is_lac, b.is_cell, b.is_wifi, b.radius_type FROM %s AS a LEFT JOIN %s AS b WHERE (a.geofence_id = b.geofence_id) AND (a.ap = \'%s\' AND  (b.valid_date + b.duration_millis >= %d) AND b.next_active_time < %d)"
    ...
    new-instance v1, Lcom/baidu/location/aq;

    float-to-double v3, v3

    float-to-double v5, v5

    invoke-direct/range {v1 .. v10}, Lcom/baidu/location/aq;-><init>(Ljava/lang/String;DDIJLjava/lang/String;)V

    if-eqz v1, :cond_1

    move/from16 v0, v27

    invoke-virtual {v1, v0}, Lcom/baidu/location/aq;->a(F)V

    invoke-virtual {v1, v15}, Lcom/baidu/location/aq;->do(Z)V

    invoke-virtual {v1, v14}, Lcom/baidu/location/aq;->a(Z)V

    invoke-virtual {v1, v13}, Lcom/baidu/location/aq;->if(Z)V

    move-object/from16 v0, p0

    iget-boolean v2, v0, Lcom/baidu/location/a0;->i3:Z
    ...
    :goto_4
    invoke-virtual {v1, v2}, Lcom/baidu/location/aq;->a(I)V
    ...
    :cond_5
    :try_start_3
    const-string v5, "SELECT distinct b.geofence_id, b.longitude, b.latitude, b.radius, b.coord_type, b.duration_millis, b.is_lac, b.is_cell, b.is_wifi, b.radius_type FROM %s AS a LEFT JOIN %s AS b WHERE (a.geofence_id = b.geofence_id) AND (a.ap <> \'%s\' AND  (b.valid_date + b.duration_millis >= %d) AND b.next_exit_active_time < %d)"
...
.method public if(Ljava/util/List;Z)Ljava/util/List;
    ...
    const-string v6, "SELECT distinct b.geofence_id, b.longitude, b.latitude, b.radius, b.coord_type, b.duration_millis, b.is_lac, b.is_cell, b.is_wifi, b.radius_type FROM %s AS a LEFT JOIN %s AS b WHERE (a.geofence_id = b.geofence_id) AND (a.ap IN (%s) AND  (b.valid_date + b.duration_millis) >= %d) AND (b.next_active_time < %d)"
    ...
    :cond_5
    :try_start_3
    const-string v6, "SELECT distinct b.geofence_id, b.longitude, b.latitude, b.radius, b.coord_type, b.duration_millis, b.is_lac, b.is_cell, b.is_wifi, b.radius_type FROM %s AS a LEFT JOIN %s AS b WHERE (a.geofence_id = b.geofence_id) AND (b.geofence_id IN (%s) AND  (b.valid_date + b.duration_millis) >= %d) AND (b.next_exit_active_time < %d)"
