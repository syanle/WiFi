...
.method private readResponseBody(Lorg/apache/commons/httpclient/HttpConnection;)Ljava/io/InputStream;
    ...
    .prologue
    .line 1816
    sget-object v14, Lorg/apache/commons/httpclient/HttpMethodBase;->LOG:Lorg/apache/commons/logging/Log;

    const-string v15, "enter HttpMethodBase.readResponseBody(HttpConnection)"

    invoke-interface {v14, v15}, Lorg/apache/commons/logging/Log;->trace(Ljava/lang/Object;)V
    ...
    iput-object v14, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->responseBody:[B
    ...
    sget-object v14, Lorg/apache/commons/httpclient/Wire;->CONTENT_WIRE:Lorg/apache/commons/httpclient/Wire;

    invoke-virtual {v14}, Lorg/apache/commons/httpclient/Wire;->enabled()Z
    ...
    .line 1821
    new-instance v8, Lorg/apache/commons/httpclient/WireLogInputStream;

    sget-object v14, Lorg/apache/commons/httpclient/Wire;->CONTENT_WIRE:Lorg/apache/commons/httpclient/Wire;

    invoke-direct {v8, v7, v14}, Lorg/apache/commons/httpclient/WireLogInputStream;-><init>(Ljava/io/InputStream;Lorg/apache/commons/httpclient/Wire;)V
    ...
    iget-object v14, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->statusLine:Lorg/apache/commons/httpclient/StatusLine;

    invoke-virtual {v14}, Lorg/apache/commons/httpclient/StatusLine;->getStatusCode()I

    move-result v14

    invoke-static {v14}, Lorg/apache/commons/httpclient/HttpMethodBase;->canResponseHaveBody(I)Z
    ...
    .line 1825
    .local v10, "result":Ljava/io/InputStream;
    move-object/from16 v0, p0

    iget-object v14, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->responseHeaders:Lorg/apache/commons/httpclient/HeaderGroup;

    const-string v15, "Transfer-Encoding"

    invoke-virtual {v14, v15}, Lorg/apache/commons/httpclient/HeaderGroup;->getFirstHeader(Ljava/lang/String;)Lorg/apache/commons/httpclient/Header;

    move-result-object v13

    .line 1828
    .local v13, "transferEncodingHeader":Lorg/apache/commons/httpclient/Header;
    if-eqz v13, :cond_5
    ...
    .line 1831
    .local v12, "transferEncoding":Ljava/lang/String;
    ...
    const-string v16, "Unsupported transfer encoding: "
    ...
    .line 1837
    :cond_1
    invoke-virtual {v13}, Lorg/apache/commons/httpclient/Header;->getElements()[Lorg/apache/commons/httpclient/HeaderElement;

    move-result-object v4

    .line 1840
    .local v4, "encodings":[Lorg/apache/commons/httpclient/HeaderElement;
    array-length v9, v4
    ...
    invoke-virtual {v15}, Lorg/apache/commons/httpclient/HeaderElement;->getName()Ljava/lang/String;
    ...
    invoke-virtual {v14}, Lorg/apache/commons/httpclient/params/HttpConnectionParams;->getSoTimeout()I

    move-result v14

    move-object/from16 v0, p1

    invoke-virtual {v0, v14}, Lorg/apache/commons/httpclient/HttpConnection;->isResponseAvailable(I)Z
    ...
    .line 1844
    new-instance v10, Lorg/apache/commons/httpclient/ChunkedInputStream;

    .end local v10    # "result":Ljava/io/InputStream;
    move-object/from16 v0, p0

    invoke-direct {v10, v7, v0}, Lorg/apache/commons/httpclient/ChunkedInputStream;-><init>(Ljava/io/InputStream;Lorg/apache/commons/httpclient/HttpMethod;)V

    .line 1880
    .end local v4    # "encodings":[Lorg/apache/commons/httpclient/HeaderElement;
    .end local v9    # "len":I
    .end local v12    # "transferEncoding":Ljava/lang/String;
    .restart local v10    # "result":Ljava/io/InputStream;
    :goto_0
    if-nez v1, :cond_a
    ...
    .line 1886
    .end local v10    # "result":Ljava/io/InputStream;
    .local v11, "result":Ljava/io/InputStream;
    :goto_1
    if-eqz v11, :cond_9

    .line 1888
    new-instance v10, Lorg/apache/commons/httpclient/AutoCloseInputStream;

    new-instance v14, Lorg/apache/commons/httpclient/HttpMethodBase$1;

    move-object/from16 v0, p0

    invoke-direct {v14, v0}, Lorg/apache/commons/httpclient/HttpMethodBase$1;-><init>(Lorg/apache/commons/httpclient/HttpMethodBase;)V

    invoke-direct {v10, v11, v14}, Lorg/apache/commons/httpclient/AutoCloseInputStream;-><init>(Ljava/io/InputStream;Lorg/apache/commons/httpclient/ResponseConsumedWatcher;)V

    .line 1898
    .end local v11    # "result":Ljava/io/InputStream;
    .restart local v10    # "result":Ljava/io/InputStream;
    :goto_2
    return-object v10

    .line 1846
    .restart local v4    # "encodings":[Lorg/apache/commons/httpclient/HeaderElement;
    .restart local v9    # "len":I
    .restart local v12    # "transferEncoding":Ljava/lang/String;
    :cond_2
    ...
    invoke-virtual {v14, v15}, Lorg/apache/commons/httpclient/params/HttpMethodParams;->isParameterTrue(Ljava/lang/String;)Z
    ...
    .line 1847
    new-instance v14, Lorg/apache/commons/httpclient/ProtocolException;

    const-string v15, "Chunk-encoded body declared but not sent"

    invoke-direct {v14, v15}, Lorg/apache/commons/httpclient/ProtocolException;-><init>(Ljava/lang/String;)V
    ...
    const-string v15, "Chunk-encoded body missing"
    ...
    const-string v15, "Response content is not chunk-encoded"
    ...
    invoke-virtual {v0, v14}, Lorg/apache/commons/httpclient/HttpMethodBase;->setConnectionCloseForced(Z)V
    ...
    iget-object v14, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->effectiveVersion:Lorg/apache/commons/httpclient/HttpVersion;

    sget-object v15, Lorg/apache/commons/httpclient/HttpVersion;->HTTP_1_1:Lorg/apache/commons/httpclient/HttpVersion;

    invoke-virtual {v14, v15}, Lorg/apache/commons/httpclient/HttpVersion;->greaterEquals(Lorg/apache/commons/httpclient/HttpVersion;)Z
    ...
    .line 1864
    .local v3, "connectionHeader":Lorg/apache/commons/httpclient/Header;
    const/4 v2, 0x0

    .line 1865
    .local v2, "connectionDirective":Ljava/lang/String;
    if-eqz v3, :cond_6
    ...
    const-string v15, "Response content length is not known"
    ...
    .line 1873
    .end local v2    # "connectionDirective":Ljava/lang/String;
    .end local v3    # "connectionHeader":Lorg/apache/commons/httpclient/Header;
    :cond_7
    move-object v10, v7
    ...
    .line 1875
    :cond_8
    new-instance v10, Lorg/apache/commons/httpclient/ContentLengthInputStream;

    .end local v10    # "result":Ljava/io/InputStream;
    invoke-direct {v10, v7, v5, v6}, Lorg/apache/commons/httpclient/ContentLengthInputStream;-><init>(Ljava/io/InputStream;J)V
    ...
    .end local v10    # "result":Ljava/io/InputStream;
    .restart local v11    # "result":Ljava/io/InputStream;
    :cond_9
    move-object v10, v11
...
.method protected addCookieRequestHeader(Lorg/apache/commons/httpclient/HttpState;Lorg/apache/commons/httpclient/HttpConnection;)V
    ...
    const-string v3, "enter HttpMethodBase.addCookieRequestHeader(HttpState, HttpConnection)"
    ...
    .line 1270
    .local v7, "cookieheaders":[Lorg/apache/commons/httpclient/Header;
    const/4 v9, 0x0
    ...
    .line 1272
    .local v6, "cookieheader":Lorg/apache/commons/httpclient/Header;
    invoke-virtual {v6}, Lorg/apache/commons/httpclient/Header;->isAutogenerated()Z
    ...
    invoke-virtual {v2, v6}, Lorg/apache/commons/httpclient/HeaderGroup;->removeHeader(Lorg/apache/commons/httpclient/Header;)V
    ...
    .line 1277
    .end local v6    # "cookieheader":Lorg/apache/commons/httpclient/Header;
    :cond_1
    ...
    .line 1278
    .local v0, "matcher":Lorg/apache/commons/httpclient/cookie/CookieSpec;
    ...
    .line 1287
    invoke-interface {v0, v8}, Lorg/apache/commons/httpclient/cookie/CookieSpec;->formatCookies([Lorg/apache/commons/httpclient/Cookie;)Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v11, v5}, Lorg/apache/commons/httpclient/Header;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V

    invoke-virtual {v2, v3}, Lorg/apache/commons/httpclient/HeaderGroup;->addHeader(Lorg/apache/commons/httpclient/Header;)V
    ...
    .line 1297
    check-cast v13, Lorg/apache/commons/httpclient/cookie/CookieVersionSupport;

    .line 1298
    .local v13, "versupport":Lorg/apache/commons/httpclient/cookie/CookieVersionSupport;
    invoke-interface {v13}, Lorg/apache/commons/httpclient/cookie/CookieVersionSupport;->getVersion()I
    ...
    invoke-virtual {v2}, Lorg/apache/commons/httpclient/Cookie;->getVersion()I
    ...
    .line 1291
    .end local v10    # "needVersionHeader":Z
    .end local v12    # "ver":I
    .end local v13    # "versupport":Lorg/apache/commons/httpclient/cookie/CookieVersionSupport;
    :cond_5
    const/4 v9, 0x0
    ...
    invoke-interface {v0, v2}, Lorg/apache/commons/httpclient/cookie/CookieSpec;->formatCookie(Lorg/apache/commons/httpclient/Cookie;)Ljava/lang/String;
    ...
    .line 1305
    .end local v11    # "s":Ljava/lang/String;
    .restart local v10    # "needVersionHeader":Z
    .restart local v12    # "ver":I
    .restart local v13    # "versupport":Lorg/apache/commons/httpclient/cookie/CookieVersionSupport;
    :cond_6
    if-eqz v10, :cond_7
    ...
    invoke-interface {v13}, Lorg/apache/commons/httpclient/cookie/CookieVersionSupport;->getVersionHeader()Lorg/apache/commons/httpclient/Header;
...
.method public getResponseBody()[B
    ...
    const-string v9, "http.method.response.buffer.warnlimit"

    const/high16 v10, 0x100000

    invoke-virtual {v7, v9, v10}, Lorg/apache/commons/httpclient/params/HttpMethodParams;->getIntParameter(Ljava/lang/String;I)I
    ...
    const-string v9, "Going to buffer response body of large or unknown size. Using getResponseBodyAsStream instead is recommended."

    invoke-interface {v7, v9}, Lorg/apache/commons/logging/Log;->warn(Ljava/lang/Object;)V

    .line 685
    :cond_2
    sget-object v7, Lorg/apache/commons/httpclient/HttpMethodBase;->LOG:Lorg/apache/commons/logging/Log;

    const-string v9, "Buffering response body"
...
.method public getResponseContentLength()J
    ...
    invoke-virtual {v6, v7}, Lorg/apache/commons/httpclient/HeaderGroup;->getHeaders(Ljava/lang/String;)[Lorg/apache/commons/httpclient/Header;
    ...
    const-string v7, "Multiple content-length headers detected"
...
.method protected processCookieHeaders(Lorg/apache/commons/httpclient/cookie/CookieSpec;[Lorg/apache/commons/httpclient/Header;Lorg/apache/commons/httpclient/HttpState;Lorg/apache/commons/httpclient/HttpConnection;)V
    ...
    iget-object v1, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->params:Lorg/apache/commons/httpclient/params/HttpMethodParams;
    ...
    .line 1624
    .local v6, "header":Lorg/apache/commons/httpclient/Header;
    const/4 v13, 0x0

    .line 1626
    .local v13, "cookies":[Lorg/apache/commons/httpclient/Cookie;
    :try_start_0
    ...
    .line 1643
    .local v12, "cookie":Lorg/apache/commons/httpclient/Cookie;
    :try_start_1
    invoke-virtual/range {p4 .. p4}, Lorg/apache/commons/httpclient/HttpConnection;->getPort()I
    ...
    invoke-interface/range {v7 .. v12}, Lorg/apache/commons/httpclient/cookie/CookieSpec;->validate(Ljava/lang/String;ILjava/lang/String;ZLorg/apache/commons/httpclient/Cookie;)V

    .line 1649
    move-object/from16 v0, p3

    invoke-virtual {v0, v12}, Lorg/apache/commons/httpclient/HttpState;->addCookie(Lorg/apache/commons/httpclient/Cookie;)V
    ...
    invoke-interface {v0, v12}, Lorg/apache/commons/httpclient/cookie/CookieSpec;->formatCookie(Lorg/apache/commons/httpclient/Cookie;)Ljava/lang/String;
    ...
    .line 1632
    .end local v12    # "cookie":Lorg/apache/commons/httpclient/Cookie;
    .end local v16    # "j":I
    :catch_0
    move-exception v14

    .line 1633
    .local v14, "e":Lorg/apache/commons/httpclient/cookie/MalformedCookieException;
    sget-object v1, Lorg/apache/commons/httpclient/HttpMethodBase;->LOG:Lorg/apache/commons/logging/Log;
    ...
    invoke-virtual {v6}, Lorg/apache/commons/httpclient/Header;->getValue()Ljava/lang/String;
    ...
    invoke-virtual {v14}, Lorg/apache/commons/httpclient/cookie/MalformedCookieException;->getMessage()Ljava/lang/String;
    ...
    .line 1654
    .end local v14    # "e":Lorg/apache/commons/httpclient/cookie/MalformedCookieException;
    .restart local v12    # "cookie":Lorg/apache/commons/httpclient/Cookie;
    .restart local v16    # "j":I
    :catch_1
    move-exception v14

    .line 1655
    .restart local v14    # "e":Lorg/apache/commons/httpclient/cookie/MalformedCookieException;
    sget-object v1, Lorg/apache/commons/httpclient/HttpMethodBase;->LOG:Lorg/apache/commons/logging/Log;
    ...
    .line 1663
    .end local v6    # "header":Lorg/apache/commons/httpclient/Header;
    .end local v13    # "cookies":[Lorg/apache/commons/httpclient/Cookie;
    :cond_4
    return-void
.end method
...
.method protected processResponseHeaders(Lorg/apache/commons/httpclient/HttpState;Lorg/apache/commons/httpclient/HttpConnection;)V
    ...
    const-string v4, "enter HttpMethodBase.processResponseHeaders(HttpState, HttpConnection)"
    ...
    .line 1585
    .local v1, "parser":Lorg/apache/commons/httpclient/cookie/CookieSpec;
    invoke-virtual {p0}, Lorg/apache/commons/httpclient/HttpMethodBase;->getResponseHeaderGroup()Lorg/apache/commons/httpclient/HeaderGroup;
...
.method protected writeRequest(Lorg/apache/commons/httpclient/HttpState;Lorg/apache/commons/httpclient/HttpConnection;)V
    ...
    invoke-virtual {p0, v5}, Lorg/apache/commons/httpclient/HttpMethodBase;->getRequestHeader(Ljava/lang/String;)Lorg/apache/commons/httpclient/Header;
