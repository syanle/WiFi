...
.method protected addRequestHeaders(Lorg/apache/commons/httpclient/HttpState;Lorg/apache/commons/httpclient/HttpConnection;)V
    ...
    invoke-virtual {p0, v1}, Lorg/apache/commons/httpclient/methods/EntityEnclosingMethod;->getRequestHeader(Ljava/lang/String;)Lorg/apache/commons/httpclient/Header;
...
.method protected writeRequestBody(Lorg/apache/commons/httpclient/HttpState;Lorg/apache/commons/httpclient/HttpConnection;)Z
    ...
    const-string v5, "enter EntityEnclosingMethod.writeRequestBody(HttpState, HttpConnection)"
    ...
    const-string v5, "Request body has not been specified"
    ...
    const-string v5, "Request body is empty"
    ...
    iget v4, p0, Lorg/apache/commons/httpclient/methods/EntityEnclosingMethod;->repeatCount:I

    if-lez v4, :cond_3

    iget-object v4, p0, Lorg/apache/commons/httpclient/methods/EntityEnclosingMethod;->requestEntity:Lorg/apache/commons/httpclient/methods/RequestEntity;

    invoke-interface {v4}, Lorg/apache/commons/httpclient/methods/RequestEntity;->isRepeatable()Z
    ...
    const-string v5, "Unbuffered entity enclosing request can not be repeated."
    ...
    iput v4, p0, Lorg/apache/commons/httpclient/methods/EntityEnclosingMethod;->repeatCount:I
    ...
    .line 496
    new-instance v3, Lorg/apache/commons/httpclient/ChunkedOutputStream;

    invoke-direct {v3, v2}, Lorg/apache/commons/httpclient/ChunkedOutputStream;-><init>(Ljava/io/OutputStream;)V
    ...
    invoke-interface {v4, v2}, Lorg/apache/commons/httpclient/methods/RequestEntity;->writeRequest(Ljava/io/OutputStream;)V

    .line 502
    instance-of v4, v2, Lorg/apache/commons/httpclient/ChunkedOutputStream;
