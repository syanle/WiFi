...
public class X509V2AttributeCertificateGenerator
{
    ...
    public void addExtension(String s, boolean flag, ASN1Encodable asn1encodable)
        throws IOException
    {
        extGenerator.addExtension(new DERObjectIdentifier(s), flag, asn1encodable);
    }

    public void addExtension(String s, boolean flag, byte abyte0[])
    {
        extGenerator.addExtension(new DERObjectIdentifier(s), flag, abyte0);
    }
    ...
    {
        acInfoGen.setSerialNumber(new DERInteger(biginteger));
    }
