...
public class X509ExtensionUtil
{
    ...
    public static ASN1Object fromExtensionValue(byte abyte0[])
        throws IOException
    {
        return ASN1Object.fromByteArray(((ASN1OctetString)ASN1Object.fromByteArray(abyte0)).getOctets());
    }
...
_L2:
        arraylist1.add(generalname.getName().getDERObject());
_L8:
...
_L4:
        try
        {
            arraylist1.add(X509Name.getInstance(generalname.getName()).toString());
        }
...
_L3:
        arraylist1.add(((ASN1String)generalname.getName()).getString());
          goto _L8
_L6:
        arraylist1.add(DERObjectIdentifier.getInstance(generalname.getName()).getId());
          goto _L8
