...
public class X509V2CRLGenerator
{
    ...
    {
        tbsGen.addCRLEntry(new DERInteger(biginteger), new Time(date), i);
    }

    public void addCRLEntry(BigInteger biginteger, Date date, int i, Date date1)
    {
        tbsGen.addCRLEntry(new DERInteger(biginteger), new Time(date), i, new DERGeneralizedTime(date1));
    }

    public void addCRLEntry(BigInteger biginteger, Date date, X509Extensions x509extensions)
    {
        tbsGen.addCRLEntry(new DERInteger(biginteger), new Time(date), x509extensions);
    }

    public void addExtension(String s, boolean flag, DEREncodable derencodable)
    {
        addExtension(new DERObjectIdentifier(s), flag, derencodable);
    }
    ...
    {
        extGenerator.addExtension(derobjectidentifier, flag, derencodable);
    }

    public void addExtension(DERObjectIdentifier derobjectidentifier, boolean flag, byte abyte0[])
    {
        extGenerator.addExtension(derobjectidentifier, flag, abyte0);
    }
