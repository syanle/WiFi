    ...
    implements PBEKey
{
    ...
    public JCEPBEKey(String s, DERObjectIdentifier derobjectidentifier, int i, int j, int k, int l, PBEKeySpec pbekeyspec, 
    ...
    void setTryWrongPKCS12Zero(boolean flag)
    {
        tryWrong = flag;
    }
