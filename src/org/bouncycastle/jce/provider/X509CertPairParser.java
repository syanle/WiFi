...
public class X509CertPairParser extends X509StreamParserSpi
{
    ...
    {
        return new X509CertificatePair(CertificatePair.getInstance((ASN1Sequence)(new ASN1InputStream(inputstream, ProviderUtil.getReadLimit(inputstream))).readObject()));
    }
