...
//            JCEDigestUtil, BouncyCastleProvider, RSAUtil
...
public class JDKPSSSigner extends SignatureSpi
{
        ...
        throws InvalidParameterException
    {
        if (algorithmparameterspec instanceof PSSParameterSpec)
        {
            ...
            if (originalSpec != null && !JCEDigestUtil.isSameDigest(originalSpec.getDigestAlgorithm(), algorithmparameterspec.getDigestAlgorithm()))
            {
            ...
            if (!JCEDigestUtil.isSameDigest(mgf1parameterspec.getDigestAlgorithm(), algorithmparameterspec.getDigestAlgorithm()))
            {
