...
//            PKCS12BagAttributeCarrierImpl, X509SignatureUtil, JDKKeyFactory, BouncyCastleProvider, 
    ...
    implements PKCS12BagAttributeCarrier
{
        ...
        throws CertificateParsingException
    {
        ...
        basicConstraints = BasicConstraints.getInstance(ASN1Object.fromByteArray(x509certificatestructure));
        try
        {
...
_L1:
        derbitstring = DERBitString.getInstance(ASN1Object.fromByteArray(x509certificatestructure));
...
_L3:
        ...
        {
            stringbuffer.append(new BasicConstraints((ASN1Sequence)asn1inputstream.readObject())).append(s);
