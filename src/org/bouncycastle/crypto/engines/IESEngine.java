...
public class IESEngine
{
        ...
        throws InvalidCipherTextException
    {
        ...
        BigInteger biginteger = agree.calculateAgreement(pubParam);
        if (forEncryption)
        {
            return encryptBlock(abyte0, i, j, biginteger.toByteArray());
        } else
        {
            return decryptBlock(abyte0, i, j, biginteger.toByteArray());
        }
    }
}
