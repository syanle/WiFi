    ...
    implements ExtendedDigest
{
    ...
    protected void processBlock()
    {
        ...
        while (j < 10) 
        {
            ...
            long al[] = W;
            int i1 = l + 1;
            l9 = l9 + l10 + l11 + al[l] + l7;
            l7 = l8 + l9;
            l8 = Sum0(l1) + Maj(l1, l3, l5) + l9;
            l9 = Sum1(l7);
            l10 = Ch(l7, l2, l4);
            l11 = K[i1];
            al = W;
            l = i1 + 1;
            l6 = l10 + l9 + l11 + al[i1] + l6;
            l5 += l6;
            l9 = Sum0(l8);
            l6 += Maj(l8, l1, l3) + l9;
            l9 = Sum1(l5);
            ...
            al = W;
            i1 = l + 1;
            l9 = l7 + (l9 + l10 + l11 + al[l]);
            l7 = l8 + l9;
            l8 = Sum0(l2);
            l8 = l9 + (Maj(l2, l4, l6) + l8);
            l9 = Sum1(l7);
            l10 = Ch(l7, l1, l3);
            l11 = K[i1];
            al = W;
            l = i1 + 1;
            l5 = l9 + l10 + l11 + al[i1] + l5;
            l6 += l5;
            l9 = Sum0(l8);
            l5 += Maj(l8, l2, l4) + l9;
            l9 = Sum1(l6);
