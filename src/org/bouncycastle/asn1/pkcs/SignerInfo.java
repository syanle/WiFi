...
public class SignerInfo extends ASN1Encodable
{
    ...
    public SignerInfo(DERInteger derinteger, IssuerAndSerialNumber issuerandserialnumber, AlgorithmIdentifier algorithmidentifier, ASN1Set asn1set, AlgorithmIdentifier algorithmidentifier1, ASN1OctetString asn1octetstring, ASN1Set asn1set1)
    {
        version = derinteger;
