...
_L1:
    ...
    public SignerLocation(DERUTF8String derutf8string, DERUTF8String derutf8string1, ASN1Sequence asn1sequence)
    {
        ...
        {
            countryName = DERUTF8String.getInstance(derutf8string.toASN1Object());
        }
        if (derutf8string1 != null)
        {
            localityName = DERUTF8String.getInstance(derutf8string1.toASN1Object());
        }
        if (asn1sequence != null)
        {
            postalAddress = ASN1Sequence.getInstance(asn1sequence.toASN1Object());
        }
    }
