...
public class X509Extensions extends ASN1Encodable
{
    ...
    public X509Extensions(Vector vector, Hashtable hashtable)
    {
        ...
        for (; vector.hasMoreElements(); ordering.addElement(new ASN1ObjectIdentifier(((DERObjectIdentifier)vector.nextElement()).getId()))) { }
        ASN1ObjectIdentifier asn1objectidentifier;
        X509Extension x509extension;
        for (vector = ordering.elements(); vector.hasMoreElements(); extensions.put(asn1objectidentifier, x509extension))
        {
            asn1objectidentifier = new ASN1ObjectIdentifier(((DERObjectIdentifier)vector.nextElement()).getId());
    ...
    public DERObject toASN1Object()
    {
        ...
        for (Enumeration enumeration = ordering.elements(); enumeration.hasMoreElements(); asn1encodablevector.add(new DERSequence(asn1encodablevector1)))
        {
            ...
            {
                asn1encodablevector1.add(new DERBoolean(true));
            }
