...
public class PersonalData extends ASN1Encodable
{
    ...
    private PersonalData(ASN1Sequence asn1sequence)
    {
        ...
        do
        {
            ...
            case 0: // '\0'
                nameDistinguisher = DERInteger.getInstance(asn1taggedobject, false).getValue();
                break;

            case 1: // '\001'
                dateOfBirth = DERGeneralizedTime.getInstance(asn1taggedobject, false);
                break;
    ...
    public PersonalData(NameOrPseudonym nameorpseudonym, BigInteger biginteger, DERGeneralizedTime dergeneralizedtime, DirectoryString directorystring, String s, DirectoryString directorystring1)
    {
