...
_L2:
        if (obj1 instanceof byte[])
        {
            try
            {
                obj1 = getInstance(ASN1Object.fromByteArray((byte[])(byte[])obj1));
            }
...
_L7:
        return new GeneralName(i, X509Name.getInstance(asn1taggedobject, true));
_L8:
        return new GeneralName(i, ASN1Sequence.getInstance(asn1taggedobject, false));
_L9:
        return new GeneralName(i, DERIA5String.getInstance(asn1taggedobject, false));
...
_L11:
        return new GeneralName(i, DERObjectIdentifier.getInstance(asn1taggedobject, false));
    }
...
_L3:
        stringbuffer.append(X509Name.getInstance(obj).toString());
