...
_L8:
        onlyContainsUserCerts = DERBoolean.getInstance(asn1taggedobject, false).isTrue();
          goto _L10
_L4:
        onlyContainsCACerts = DERBoolean.getInstance(asn1taggedobject, false).isTrue();
          goto _L10
_L5:
        onlySomeReasons = new ReasonFlags(ReasonFlags.getInstance(asn1taggedobject, false));
          goto _L10
_L6:
        indirectCRL = DERBoolean.getInstance(asn1taggedobject, false).isTrue();
          goto _L10
        onlyContainsAttributeCerts = DERBoolean.getInstance(asn1taggedobject, false).isTrue();
          goto _L10
    }
