...
public class c extends d
{
    ...
    public c(int j, byte abyte0[], boolean flag)
    {
        ...
        if (abyte0 != null)
        {
            if (n(abyte0))
            {
                abyte0 = com.umeng.socom.util.a.f(abyte0);
    ...
    {
        return b(com.umeng.socom.util.a.f(s1));
    }
...
_L5:
    ...
    {
        return com.umeng.socom.util.a.f(a(abyte0, false));
    }
    ...
    {
        return com.umeng.socom.util.a.f(a(abyte0, false, true));
    }
