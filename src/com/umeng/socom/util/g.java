...
public class g
{
    ...
    public static String a(Context context, long l)
    {
        ...
        if (l < 0xf4240L)
        {
            return (new StringBuilder(String.valueOf(Math.round((double)l / 1000D)))).append("K").toString();
        }
        if (l < 0x3b9aca00L)
        {
            return (new StringBuilder(String.valueOf((new DecimalFormat("#0.0")).format((double)l / 1000000D)))).append("M").toString();
        } else
        {
            return (new StringBuilder(String.valueOf((new DecimalFormat("#0.00")).format((double)l / 1000000000D)))).append("G").toString();
        }
    }
