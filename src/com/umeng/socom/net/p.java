...
public class p
{
    ...
    public static final class b extends Enum
    {
        ...
        {
            return (b)Enum.valueOf(com/umeng/socom/net/p$b, s);
        }
...
_L1:
    ...
    private static final String b = com/umeng/socom/net/p.getName();
...
_L3:
        a1.a(o.a.b);
        return;
        (new c(context, imageview, s, b.b, null, flag, a1, animation, flag1)).execute(new Object[0]);
        return;
    }
