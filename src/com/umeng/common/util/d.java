...
public abstract class d
{
    ...
    public boolean b(byte abyte0[], boolean flag)
    {
        ...
        {
            if (!b(abyte0[i1]) && (!flag || abyte0[i1] != 61 && !c(abyte0[i1])))
            {
                return false;
            }
        }
    ...
    {
        return k(com.umeng.common.util.a.f(s));
    }
    ...
    {
        return b(com.umeng.common.util.a.f(s), true);
    }

    public String j(byte abyte0[])
    {
        return com.umeng.common.util.a.f(l(abyte0));
    }
