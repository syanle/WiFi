...
public static final class memoizedSerializedSize extends age
    implements rBuilder
{
        ...
        implements DescriptorProtos.MethodOptionsOrBuilder
    {
        ...
        {
            DescriptorProtos.MethodOptions methodoptions = new DescriptorProtos.MethodOptions(this, null);
            int i = bitField0_;
            if (uninterpretedOptionBuilder_ == null)
            {
                if ((bitField0_ & 1) == 1)
...
_L3:
    ...
    {
        getSerializedSize();
        age.ExtensionWriter extensionwriter = newExtensionWriter();
...
/*
    static List access$16702(Builder builder, List list)
    {
