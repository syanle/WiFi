    ...
    public boolean shouldOverrideUrlLoading(WebView webview, final String url)
    {
        ...
        if (url.endsWith(".apk"))
        {
            ...
            if (WelcomePage.access$0(WelcomePage.this, pack, launchActivity))
            {
                ...
                {
                    WelcomePage.access$1(WelcomePage.this, "\u8BF7\u4E0B\u8F7D\u6700\u65B0\u7248\u672C\uFF01");
                    return true;
                }
                return true;
            } else
            {
                WelcomePage.access$2(WelcomePage.this, (new android.app.Page(WelcomePage.this)).e("\u662F\u5426\u4E0B\u8F7D\u8BE5\u5E94\u7528\uFF1F").veButton("\u786E\u5B9A", new android.content.DialogInterface.OnClickListener() {
            ...
            
            {
                ...
                WelcomePage.access$3(WelcomePage.this).show();
                return true;
            }
        } else
        {
