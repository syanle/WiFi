...
_L6:
        ...
        ((android.content.ces.Editor) (obj)).putString("item", fileName);
        ((android.content.ces.Editor) (obj)).putString("intro", message);
        ((android.content.ces.Editor) (obj)).putString("version_name", s1);
        ((android.content.ces.Editor) (obj)).putString("update_grade", s);
        ((android.content.ces.Editor) (obj)).putInt("version_code", i);
        ((android.content.ces.Editor) (obj)).commit();
