...
public class DownloadService extends Service
{
    ...
    private void displayNotificationMessage(int i)
    {
        ...
        Notification notification = new Notification(0x7f02006b, "\u6B63\u5728\u4E0B\u8F7D...", System.currentTimeMillis());
        ...
        RemoteViews remoteviews = new RemoteViews(getPackageName(), 0x7f03000a);
        remoteviews.setTextViewText(0x7f0c0028, (new StringBuilder("\u5F53\u524D\u8FDB\u5EA6\uFF1A")).append(i).append("% ").toString());
        remoteviews.setProgressBar(0x7f0c0029, 100, i, false);
