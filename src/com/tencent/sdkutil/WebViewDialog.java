...
public class WebViewDialog extends Dialog
{
    ...
    public WebViewDialog(Context context, String s, String s1, IUiListener iuilistener, QQToken qqtoken)
    {
...
_L3:
            ...
            return;
_L4:
            if (WebViewDialog.sWeakContext != null && WebViewDialog.sWeakContext.get() != null)
            {
                WebViewDialog.showTips((Context)WebViewDialog.sWeakContext.get(), (String)message.obj);
                return;
            }
            continue; /* Loop/switch isn't completed */
_L5:
            if (WebViewDialog.sWeakProcessBar != null && WebViewDialog.sWeakProcessBar.get() != null)
            {
                ((View)WebViewDialog.sWeakProcessBar.get()).setVisibility(8);
                return;
            }
            continue; /* Loop/switch isn't completed */
_L6:
            if (WebViewDialog.sWeakContext != null && WebViewDialog.sWeakContext.get() != null)
            {
                WebViewDialog.showProcessDialog((Context)WebViewDialog.sWeakContext.get(), (String)message.obj);
                return;
            }
...
_L7:
    ...
    private class FbWebViewClient extends WebViewClient
    {
        ...
        public void onPageStarted(WebView webview, String s, Bitmap bitmap)
        {
            ...
            if (WebViewDialog.sWeakProcessBar != null && WebViewDialog.sWeakProcessBar.get() != null)
            {
                ((View)WebViewDialog.sWeakProcessBar.get()).setVisibility(0);
            }
        }
        ...
        public void onReceivedError(WebView webview, int i, String s, String s1)
        {
            ...
            if (WebViewDialog.sWeakContext != null && WebViewDialog.sWeakContext.get() != null)
            {
                Toast.makeText((Context)WebViewDialog.sWeakContext.get(), "\u7F51\u7EDC\u8FDE\u63A5\u5F02\u5E38\u6216\u7CFB\u7EDF\u9519\u8BEF", 0).show();
            }
            dismiss();
        }
        ...
        public boolean shouldOverrideUrlLoading(WebView webview, String s)
        {
            ...
            if (s.startsWith(ServerSetting.getInstance().getSettingUrl((Context)WebViewDialog.sWeakContext.get(), 1)))
            {
            ...
            if (s.startsWith("download://"))
            {
                ...
                if (WebViewDialog.sWeakContext != null && WebViewDialog.sWeakContext.get() != null)
                {
                    ((Context)WebViewDialog.sWeakContext.get()).startActivity(webview);
                }
                return true;
            } else
            {
