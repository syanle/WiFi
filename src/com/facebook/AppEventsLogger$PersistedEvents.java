...
_L4:
        obj1 = obj;
        Log.d(AppEventsLogger.access$0(), (new StringBuilder("Got unexpected exception: ")).append(((Exception) (obj3)).toString()).toString());
        Utility.closeQuietly(((java.io.Closeable) (obj)));
        return;
        obj;
_L2:
...
_L4:
        obj = obj1;
        Log.d(AppEventsLogger.access$0(), (new StringBuilder("Got unexpected exception: ")).append(((Exception) (obj2)).toString()).toString());
        Utility.closeQuietly(((java.io.Closeable) (obj1)));
        return;
        obj1;
_L2:
