...
_L3:
    ...
    private void authorize(Activity activity, String as[], int i, SessionLoginBehavior sessionloginbehavior, final DialogListener listener)
    {
        ...
        pendingAuthorizationPermissions = as;
        as = new com.facebook.Session.StatusCallback() {
        ...
        activity = (new com.facebook.Session.OpenRequest(activity)).setCallback(as).setLoginBehavior(sessionloginbehavior).setRequestCode(i).setPermissions(Arrays.asList(pendingAuthorizationPermissions));
