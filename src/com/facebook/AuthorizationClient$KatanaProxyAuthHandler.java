...
class > extends >
{
    ...
    private > handleResultOk(Intent intent)
    {
        ...
        {
            AuthorizationClient.access$1(AuthorizationClient.this, applicationId, s1);
        }
    ...
    boolean tryAuthorize(handleResultOk handleresultok)
    {
        ...
        Intent intent = NativeProtocol.createProxyAuthIntent(context, handleresultok.tApplicationId(), handleresultok.tPermissions(), s);
