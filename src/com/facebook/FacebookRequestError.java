...
//            FacebookServiceException, ResContainer, FacebookException
...
_L5:
        ...
        return;
_L2:
        s1 = ResContainer.getResContainer();
        jsonobject = ResContainer.getContext();
...
label0:
            {
                ...
                l = s1.getResourceId(jsonobject, ResContainer.ResType.STRING, "com_facebook_requesterror_permissions");
                flag3 = flag4;
            }
        }
          goto _L6
...
_L8:
        if (k == 459 || k == 464)
        {
            ...
            l = s1.getResourceId(jsonobject, ResContainer.ResType.STRING, "com_facebook_requesterror_web_login");
            flag3 = true;
        } else
        {
            ...
            if (k == 458 || k == 463)
            {
                l = s1.getResourceId(jsonobject, ResContainer.ResType.STRING, "com_facebook_requesterror_relogin");
                flag3 = flag4;
            } else
            if (k == 460)
            {
                l = s1.getResourceId(jsonobject, ResContainer.ResType.STRING, "com_facebook_requesterror_password_changed");
                flag3 = flag4;
            } else
            {
                l = s1.getResourceId(jsonobject, ResContainer.ResType.STRING, "com_facebook_requesterror_reconnect");
                flag3 = true;
            }
        }
          goto _L6
