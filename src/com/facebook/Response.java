...
public class Response
{
        ...
        throws JSONException
    {
        ...
        if (obj instanceof JSONObject)
        {
            ...
            if (obj instanceof JSONObject)
            {
                return new Response(request1, httpurlconnection, com.facebook.model.GraphObject.Factory.create((JSONObject)obj), flag);
            }
            if (obj instanceof JSONArray)
            {
                return new Response(request1, httpurlconnection, com.facebook.model.GraphObject.Factory.createList((JSONArray)obj, com/facebook/model/GraphObject), flag);
            }
