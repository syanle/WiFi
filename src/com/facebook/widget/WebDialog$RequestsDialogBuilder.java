...
public static class _cls9 extends _cls9
{
    ...
    public volatile getParameters setOnCompleteListener(getParameters getparameters)
    {
        return super.eteListener(getparameters);
    }

    public volatile eteListener setTheme(int i)
    {
        return super.eteListener(i);
    }

    public eteListener setTitle(String s)
    {
