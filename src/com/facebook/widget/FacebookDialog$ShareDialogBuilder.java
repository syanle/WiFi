...
public static class  extends 
{
    ...
    {
        return FacebookDialog.canPresentShareDialog(activity, new activity[] {
            SHARE_DIALOG
        });
    }

    public volatile SHARE_DIALOG setApplicationName(String s)
    {
        return super.ionName(s);
    }

    public ionName setCaption(String s)
    {
        caption = s;
        return this;
    }
    ...
    public volatile description setFragment(Fragment fragment)
    {
        return super.(fragment);
    }

    public  setFriends(List list)
    {
    ...
    public volatile ref setRequestCode(int i)
    {
        return super.ode(i);
    }
