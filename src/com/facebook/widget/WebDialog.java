...
public class WebDialog extends Dialog
{
    ...
    public WebDialog(Context context, String s, Bundle bundle, int i, OnCompleteListener oncompletelistener)
    {
        ...
        url = Utility.buildUri(ServerProtocol.getDialogAuthority(), (new StringBuilder("dialog/")).append(s).toString(), context).toString();
    ...
    private void createCrossImage()
    {
        ...
        Drawable drawable = getContext().getResources().getDrawable(mResContainer.getResourceId(com.facebook.ResContainer.ResType.DRAWABLE, "umeng_socialize_facebook_close"));
    ...
    private Pair getMargins()
    {
        ...
        {
            d = 0.59999999999999998D + ((double)(1024 - k) / 512D) * 0.40000000000000002D;
        }
        return new Pair(Integer.valueOf((int)(((double)i * (1.0D - d)) / 2D)), Integer.valueOf((int)(((double)j * (1.0D - d)) / 2D)));
    }
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        spinner.setMessage(getContext().getString(mResContainer.getResourceId(com.facebook.ResContainer.ResType.STRING, "com_facebook_loading")));
        ...
        bundle = getMargins();
        contentFrameLayout.setPadding(((Integer)((Pair) (bundle)).first).intValue(), ((Integer)((Pair) (bundle)).second).intValue(), ((Integer)((Pair) (bundle)).first).intValue(), ((Integer)((Pair) (bundle)).second).intValue());
        createCrossImage();
