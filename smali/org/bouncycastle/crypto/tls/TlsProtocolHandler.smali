...
.method public constructor <init>(Ljava/io/InputStream;Ljava/io/OutputStream;Ljava/security/SecureRandom;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->tlsOutputStream:Lorg/bouncycastle/crypto/tls/TlsOutputStream;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->securityParameters:Lorg/bouncycastle/crypto/tls/SecurityParameters;

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->tlsClientContext:Lorg/bouncycastle/crypto/tls/TlsClientContextImpl;

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->tlsClient:Lorg/bouncycastle/crypto/tls/TlsClient;

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->offeredCipherSuites:[I

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->offeredCompressionMethods:[S

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->keyExchange:Lorg/bouncycastle/crypto/tls/TlsKeyExchange;

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->authentication:Lorg/bouncycastle/crypto/tls/TlsAuthentication;

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->certificateRequest:Lorg/bouncycastle/crypto/tls/CertificateRequest;
...
.method private processHandshake()V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->handshakeQueue:Lorg/bouncycastle/crypto/tls/ByteQueue;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->handshakeQueue:Lorg/bouncycastle/crypto/tls/ByteQueue;
    ...
    invoke-virtual {v5, v0, v1, v7}, Lorg/bouncycastle/crypto/tls/RecordStream;->updateHandshakeData([BII)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->rs:Lorg/bouncycastle/crypto/tls/RecordStream;

    invoke-virtual {v0, v4, v1, v2}, Lorg/bouncycastle/crypto/tls/RecordStream;->updateHandshakeData([BII)V
...
.method private processHandshakeMessage(S[B)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->authentication:Lorg/bouncycastle/crypto/tls/TlsAuthentication;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->securityParameters:Lorg/bouncycastle/crypto/tls/SecurityParameters;
    ...
    iput-boolean v4, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->appDataReady:Z
    ...
    :cond_2
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->tlsClient:Lorg/bouncycastle/crypto/tls/TlsClient;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->offeredCipherSuites:[I
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->offeredCompressionMethods:[S
    ...
    sget-object v5, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->EXT_RenegotiationInfo:Ljava/lang/Integer;
    ...
    sget-object v0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->EXT_RenegotiationInfo:Ljava/lang/Integer;
    ...
    sget-object v3, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->emptybuf:[B
    ...
    iput-short v6, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->connection_state:S
    ...
    :pswitch_3
    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->keyExchange:Lorg/bouncycastle/crypto/tls/TlsKeyExchange;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->certificateRequest:Lorg/bouncycastle/crypto/tls/CertificateRequest;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/tls/RecordStream;->getCurrentHash()[B
    ...
    invoke-virtual {v1, v3, v0, v2, v4}, Lorg/bouncycastle/crypto/tls/RecordStream;->writeMessage(S[BII)V
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->securityParameters:Lorg/bouncycastle/crypto/tls/SecurityParameters;

    iget-object v4, v4, Lorg/bouncycastle/crypto/tls/SecurityParameters;->clientRandom:[B

    iget-object v5, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->securityParameters:Lorg/bouncycastle/crypto/tls/SecurityParameters;

    iget-object v5, v5, Lorg/bouncycastle/crypto/tls/SecurityParameters;->serverRandom:[B
    ...
    iput-object v3, v1, Lorg/bouncycastle/crypto/tls/SecurityParameters;->masterSecret:[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->tlsClient:Lorg/bouncycastle/crypto/tls/TlsClient;

    invoke-interface {v3}, Lorg/bouncycastle/crypto/tls/TlsClient;->getCipher()Lorg/bouncycastle/crypto/tls/TlsCipher;

    move-result-object v3

    invoke-virtual {v0, v1, v3}, Lorg/bouncycastle/crypto/tls/RecordStream;->clientCipherSpecDecided(Lorg/bouncycastle/crypto/tls/TlsCompression;Lorg/bouncycastle/crypto/tls/TlsCipher;)V
...
.method private safeWriteMessage(S[BII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lorg/bouncycastle/crypto/tls/RecordStream;->writeMessage(S[BII)V
    :try_end_0
    .catch Lorg/bouncycastle/crypto/tls/TlsFatalAlert; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_2
...
.method public connect(Lorg/bouncycastle/crypto/tls/TlsClient;)V
    ...
    iget-object v1, v1, Lorg/bouncycastle/crypto/tls/SecurityParameters;->clientRandom:[B
    ...
    invoke-direct {v0, v1, v4}, Lorg/bouncycastle/crypto/tls/TlsClientContextImpl;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/tls/SecurityParameters;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->tlsClientContext:Lorg/bouncycastle/crypto/tls/TlsClientContextImpl;
    ...
    sget-object v1, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->EXT_RenegotiationInfo:Ljava/lang/Integer;
    ...
    :goto_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->offeredCipherSuites:[I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->clientExtensions:Ljava/util/Hashtable;
    ...
    invoke-direct {v0, p0}, Lorg/bouncycastle/crypto/tls/TlsOutputStream;-><init>(Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;)V
