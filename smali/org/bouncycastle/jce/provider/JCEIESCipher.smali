...
.method protected engineDoFinal([BII[BI)I
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->buffer:Ljava/io/ByteArrayOutputStream;

    invoke-virtual {v1}, Ljava/io/ByteArrayOutputStream;->reset()V

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->cipher:Lorg/bouncycastle/crypto/engines/IESEngine;
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParam:Ljava/security/AlgorithmParameters;

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParams:Lorg/bouncycastle/jce/spec/IESParameterSpec;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParam:Ljava/security/AlgorithmParameters;

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParam:Ljava/security/AlgorithmParameters;

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParams:Lorg/bouncycastle/jce/spec/IESParameterSpec;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    ...
    :goto_0
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->availableSpecs:[Ljava/lang/Class;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/asymmetric/ec/ECUtil;->generatePublicKeyParameter(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParams:Lorg/bouncycastle/jce/spec/IESParameterSpec;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParams:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    invoke-virtual {v4}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->getEncodingV()[B

    move-result-object v4

    iget-object v5, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->engineParams:Lorg/bouncycastle/jce/spec/IESParameterSpec;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->buffer:Ljava/io/ByteArrayOutputStream;
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/DHUtil;->generatePublicKeyParameter(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/DHUtil;->generatePrivateKeyParameter(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    :pswitch_0
    iget-object v3, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->cipher:Lorg/bouncycastle/crypto/engines/IESEngine;
    ...
    invoke-virtual {v3, v4, v1, v2, v0}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(ZLorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;)V
