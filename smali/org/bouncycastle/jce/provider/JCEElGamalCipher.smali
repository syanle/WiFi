.class public Lorg/bouncycastle/jce/provider/JCEElGamalCipher;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/jce/provider/JCEElGamalCipher$NoPadding;,
        Lorg/bouncycastle/jce/provider/JCEElGamalCipher$PKCS1v1_5Padding;
    }
.end annotation
...
.method public constructor <init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->cipher:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
...
.method private initFromSpec(Ljavax/crypto/spec/OAEPParameterSpec;)V
    ...
    iput-object v2, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->cipher:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->paramSpec:Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineDoFinal([BII[BI)I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->cipher:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->engineParams:Ljava/security/AlgorithmParameters;

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->paramSpec:Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->engineParams:Ljava/security/AlgorithmParameters;

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->engineParams:Ljava/security/AlgorithmParameters;

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->paramSpec:Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/ElGamalUtil;->generatePublicKeyParameter(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/ElGamalUtil;->generatePrivateKeyParameter(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    :pswitch_0
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->cipher:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
...
.method protected engineSetPadding(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->initFromSpec(Ljavax/crypto/spec/OAEPParameterSpec;)V
