...
.method private decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    sget-object v2, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->PROVIDER_NAME:Ljava/lang/String;
...
.method public engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;->getObject()Ljava/lang/Object;
...
.method public engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;->getAlias()Ljava/lang/String;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-static {v4, v7}, Lorg/bouncycastle/util/Arrays;->fill([BB)V
    ...
    invoke-virtual {p0, v1}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->loadStore(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v3, v1, v7}, Lorg/bouncycastle/crypto/macs/HMac;->doFinal([BI)I
...
.method public engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    :cond_0
    :try_start_0
    iget-object v6, p0, Lorg/bouncycastle/jce/provider/JDKKeyStore;->table:Ljava/util/Hashtable;
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    iget-object v4, p0, Lorg/bouncycastle/jce/provider/JDKKeyStore;->random:Ljava/security/SecureRandom;
    ...
    :cond_0
    invoke-virtual {p0, v5}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->saveStore(Ljava/io/OutputStream;)V
...
.method protected loadStore(Ljava/io/InputStream;)V
    ...
    invoke-direct {p0, v7}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;-><init>(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;)V
    ...
    :pswitch_1
    invoke-direct {p0, v7}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;-><init>(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;[Ljava/security/cert/Certificate;)V
...
.method protected makePBECipher(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    sget-object v3, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->PROVIDER_NAME:Ljava/lang/String;
...
.method protected saveStore(Ljava/io/OutputStream;)V
    ...
    invoke-direct {p0, v6, v4}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->encodeCertificate(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, v0, v4}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->encodeCertificate(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, v0, v4}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->encodeKey(Ljava/security/Key;Ljava/io/DataOutputStream;)V
