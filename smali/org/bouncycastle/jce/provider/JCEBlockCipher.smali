...
.method protected engineDoFinal([BII[BI)I
    ...
    invoke-interface {v1, p4, v2}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$GenericBlockCipher;->doFinal([BI)I
    :try_end_0
...
.method protected engineDoFinal([BII)[B
    ...
    invoke-interface {v1, v4, v0}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$GenericBlockCipher;->doFinal([BI)I
    :try_end_0
    .catch Lorg/bouncycastle/crypto/DataLengthException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lorg/bouncycastle/crypto/InvalidCipherTextException; {:try_start_0 .. :try_end_0} :catch_1
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEBlockCipher;->ivParam:Lorg/bouncycastle/crypto/params/ParametersWithIV;
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/JCEBlockCipher;->padded:Z
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/JCEBlockCipher;->isAEADModeName(Ljava/lang/String;)Z
    ...
    invoke-interface {v1, v2, v0}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$GenericBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method protected engineSetMode(Ljava/lang/String;)V
    ...
    iput v3, p0, Lorg/bouncycastle/jce/provider/JCEBlockCipher;->ivLength:I
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$BufferedGenericBlockCipher;-><init>(Lorg/bouncycastle/crypto/BufferedBlockCipher;)V
    ...
    new-instance v0, Lorg/bouncycastle/jce/provider/JCEBlockCipher$AEADGenericBlockCipher;
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$AEADGenericBlockCipher;-><init>(Lorg/bouncycastle/crypto/modes/AEADBlockCipher;)V
...
.method protected engineSetPadding(Ljava/lang/String;)V
    ...
    invoke-interface {v0}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$GenericBlockCipher;->wrapOnNoPadding()Z
    ...
    invoke-direct {v0, v1, v2}, Lorg/bouncycastle/jce/provider/JCEBlockCipher$BufferedGenericBlockCipher;-><init>(Lorg/bouncycastle/crypto/BlockCipher;Lorg/bouncycastle/crypto/paddings/BlockCipherPadding;)V
