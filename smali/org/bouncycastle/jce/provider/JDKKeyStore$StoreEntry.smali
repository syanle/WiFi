...
.method constructor <init>(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    iget-object v0, p1, Lorg/bouncycastle/jce/provider/JDKKeyStore;->random:Ljava/security/SecureRandom;
    ...
    # invokes: Lorg/bouncycastle/jce/provider/JDKKeyStore;->encodeKey(Ljava/security/Key;Ljava/io/DataOutputStream;)V
    invoke-static {p1, p3, v0}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->access$000(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/security/Key;Ljava/io/DataOutputStream;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;->obj:Ljava/lang/Object;
...
.method constructor <init>(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/lang/String;Ljava/security/cert/Certificate;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;->certChain:[Ljava/security/cert/Certificate;
...
.method getObject([C)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JDKKeyStore$StoreEntry;->this$0:Lorg/bouncycastle/jce/provider/JDKKeyStore;
    ...
    # invokes: Lorg/bouncycastle/jce/provider/JDKKeyStore;->decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    invoke-static {v0, v2}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->access$100(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/io/DataInputStream;)Ljava/security/Key;
    :try_end_1
    ...
    # invokes: Lorg/bouncycastle/jce/provider/JDKKeyStore;->encodeKey(Ljava/security/Key;Ljava/io/DataOutputStream;)V
    invoke-static {v1, v6, v0}, Lorg/bouncycastle/jce/provider/JDKKeyStore;->access$000(Lorg/bouncycastle/jce/provider/JDKKeyStore;Ljava/security/Key;Ljava/io/DataOutputStream;)V
