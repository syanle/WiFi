...
.method protected static createSingleton(Ljava/lang/String;)Lorg/dom4j/DocumentFactory;
    ...
    :try_start_0
    sget-object v2, Lorg/dom4j/DocumentFactory;->class$org$dom4j$DocumentFactory:Ljava/lang/Class;

    if-nez v2, :cond_0

    const-string v2, "org.dom4j.DocumentFactory"

    invoke-static {v2}, Lorg/dom4j/DocumentFactory;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lorg/dom4j/DocumentFactory;->class$org$dom4j$DocumentFactory:Ljava/lang/Class;
    ...
    check-cast v2, Lorg/dom4j/DocumentFactory;
    ...
    const-string v4, "WARNING: Cannot load DocumentFactory: "
    ...
    .line 383
    new-instance v2, Lorg/dom4j/DocumentFactory;

    invoke-direct {v2}, Lorg/dom4j/DocumentFactory;-><init>()V
