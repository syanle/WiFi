.class public Lcom/iwifi/sdk/tools/XmlParser;
...
.method private static domParseElement(Lorg/w3c/dom/NodeList;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 89
    .local p1, "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    const/4 v7, 0x0
    ...
    .line 97
    new-instance v5, Lcom/iwifi/sdk/tools/XMLData;

    invoke-direct {v5}, Lcom/iwifi/sdk/tools/XMLData;-><init>()V

    .line 98
    .local v5, "data":Lcom/iwifi/sdk/tools/XMLData;
    invoke-interface {v6}, Lorg/w3c/dom/Element;->getNodeName()Ljava/lang/String;

    move-result-object v12

    iput-object v12, v5, Lcom/iwifi/sdk/tools/XMLData;->tagName:Ljava/lang/String;
    ...
    iput-object v12, v5, Lcom/iwifi/sdk/tools/XMLData;->attributes:Ljava/util/ArrayList;
    ...
    .line 116
    iput-object v11, v5, Lcom/iwifi/sdk/tools/XMLData;->characters:Ljava/lang/String;
    ...
    .line 125
    .local v3, "childs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    invoke-static {v2, v3}, Lcom/iwifi/sdk/tools/XmlParser;->domParseElement(Lorg/w3c/dom/NodeList;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    .end local v3    # "childs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    .end local v4    # "count":I
    .end local v5    # "data":Lcom/iwifi/sdk/tools/XMLData;
    ...
    .restart local v5    # "data":Lcom/iwifi/sdk/tools/XMLData;
    ...
    iput-object v12, v0, Lcom/iwifi/sdk/tools/XMLData$XMLAttributes;->name:Ljava/lang/String;
    ...
    iput-object v12, v0, Lcom/iwifi/sdk/tools/XMLData$XMLAttributes;->value:Ljava/lang/String;

    .line 107
    iget-object v12, v5, Lcom/iwifi/sdk/tools/XMLData;->attributes:Ljava/util/ArrayList;
...
.method public static parseXmlByDom(Ljava/io/InputStream;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 72
    .local v4, "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    invoke-static {v5, v4}, Lcom/iwifi/sdk/tools/XmlParser;->domParseElement(Lorg/w3c/dom/NodeList;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    .line 68
    .end local v4    # "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
...
.method public static parseXmlByPull(Ljava/io/InputStream;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .local v2, "dataList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    :goto_0
    const/4 v9, 0x1
    ...
    .line 184
    .end local v2    # "dataList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    ...
    .line 142
    .end local v1    # "dataList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    .restart local v2    # "dataList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
    ...
    .line 151
    invoke-static {v7, v6}, Lcom/iwifi/sdk/tools/XmlParser;->setData(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Lcom/iwifi/sdk/tools/XMLData;
    ...
    .line 155
    .local v0, "data":Lcom/iwifi/sdk/tools/XMLData;
    if-eqz v8, :cond_4

    .line 156
    iput-object v8, v0, Lcom/iwifi/sdk/tools/XMLData;->preTag:Ljava/lang/String;
    ...
    check-cast v9, Lcom/iwifi/sdk/tools/XMLData;

    iput-object v6, v9, Lcom/iwifi/sdk/tools/XMLData;->nextTag:Ljava/lang/String;
    ...
    .line 166
    .end local v0    # "data":Lcom/iwifi/sdk/tools/XMLData;
    .end local v1    # "dataList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/iwifi/sdk/tools/XMLData;>;"
...
.method public static parseXmlBySax(Ljava/io/InputStream;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    new-instance v1, Lcom/iwifi/sdk/tools/XMLContentHandler;

    invoke-direct {v1, p1}, Lcom/iwifi/sdk/tools/XMLContentHandler;-><init>(Ljava/lang/String;)V

    .line 36
    .local v1, "handler":Lcom/iwifi/sdk/tools/XMLContentHandler;
    invoke-virtual {v2, p0, v1}, Ljavax/xml/parsers/SAXParser;->parse(Ljava/io/InputStream;Lorg/xml/sax/helpers/DefaultHandler;)V

    .line 37
    invoke-virtual {v1}, Lcom/iwifi/sdk/tools/XMLContentHandler;->getXmlData()Ljava/util/ArrayList;
    :try_end_0
    .catch Ljavax/xml/parsers/ParserConfigurationException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lorg/xml/sax/SAXException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_2
    ...
    .line 49
    .end local v1    # "handler":Lcom/iwifi/sdk/tools/XMLContentHandler;
...
.method private static setData(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Lcom/iwifi/sdk/tools/XMLData;
    .locals 6
    ...
    iput-object p1, v2, Lcom/iwifi/sdk/tools/XMLData;->tagName:Ljava/lang/String;
    ...
    iput-object v5, v2, Lcom/iwifi/sdk/tools/XMLData;->attributes:Ljava/util/ArrayList;
    ...
    .line 204
    iput-object v4, v2, Lcom/iwifi/sdk/tools/XMLData;->characters:Ljava/lang/String;
    ...
    iput-object v5, v0, Lcom/iwifi/sdk/tools/XMLData$XMLAttributes;->name:Ljava/lang/String;
    ...
    iput-object v5, v0, Lcom/iwifi/sdk/tools/XMLData$XMLAttributes;->value:Ljava/lang/String;

    .line 198
    iget-object v5, v2, Lcom/iwifi/sdk/tools/XMLData;->attributes:Ljava/util/ArrayList;
